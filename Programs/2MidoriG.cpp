...
f0_0=d1&b1^d1^1   || f1_0=a1^1       || f2_0=d1&b1^1        || f3_0=d1&b1^d1&c1^1     
f0_1=d1&b2^c2     || f1_1=0          || f2_1=d1&b2^c2       || f3_1=d1&b2^d1&c2^b2     
f0_2=d1&b3        || f1_2=0          || f2_2=d1&b3          || f3_2=d1&b3^d1&c3        
f0_3=d2&b1^c1     || f1_3=0          || f2_3=d2&b1^c1       || f3_3=d2&b1^d2&c1^b1     
f0_4=d2&b2^d2     || f1_4=a2         || f2_4=d2&b2          || f3_4=d2&b2^d2&c2    
f0_5=d2&b3        || f1_5=0          || f2_5=d2&b3          || f3_5=d2&b3^d2&c3        
f0_6=d3&b1        || f1_6=0          || f2_6=d3&b1          || f3_6=d3&b1^d3&c1        
f0_7=d3&b2        || f1_7=0          || f2_7=d3&b2          || f3_7=d3&b2^d3&c2        
f0_8=d3&b3^d3^c3  || f1_8=a3         || f2_8=d3&b3^c3       || f3_8=d3&b3^d3&c3^b3  
 */
...
//ExpressionType
#define  EType_dANDbXORc         1  // 1 this suits for the case of  d&b^c
#define  EType_dANDbcXORb        2  // 2 this suits for the case of  d&b^d&c^b
...
)// InitLinearItem1[CompIndex]:CompIndex:0-8;  TransLinearItem[CompIndex][Type]:Type:0-7, XorValue[CompIndex][Type][Masked_InputIndex]: Masked_InputIndex:0-4095.
{
	...
	// 3  need to  change  with different implementations.the linear items in the  9 initail components 		
		f0[0]=d1&b1^d1     ;//   This the  original expression :f0[0]=d1&b1^d1^1. Note must remove "1".  
	    f0[1]=d1&b2^c2     ;
	    f0[2]=d1&b3        ;
	    f0[3]=d2&b1^c1     ;
	    f0[4]=d2&b2^d2     ;
	    ...
	    f2[0]=d1&b1  ; //   This the  original expression : f2[0]=d1&b1^1. Note must remove "1".  
	    f2[1]=d1&b2^c2   ;
	    f2[2]=d1&b3      ;
	    f2[3]=d2&b1^c1   ;
	    f2[4]=d2&b2      ;
	    ...
	    f3[0]=d1&b1^d1&c1  ;//This the  original expression :  f3[0]=d1&b1^d1&c1^1. Note must remove "1".  
	    f3[1]=d1&b2^d1&c2^b2  ;
	    f3[2]=d1&b3^d1&c3     ;
	    f3[3]=d2&b1^d2&c1^b1  ;
	    f3[4]=d2&b2^d2&c2    ;
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
		...
		else if(ExpressionType[CoordIndex]==EType_dANDbcXORb)//Expression Typ2
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				CoordIndex=1;
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=a1<<3;
				...
				InputTableIndex[CoordIndex][4][Masked_InputIndex]=a2<<3;
				...
				InputTableIndex[CoordIndex][8][Masked_InputIndex]=a3<<3;
				...
				f0_1= d1&b1^d1^1  ^ XorValue[0][0][Type[0][0]][Masked_InputIndex]   ;
				...
				f2_1=d1&b1^1       ^ XorValue[2][0][Type[2][0]][Masked_InputIndex];  
                ...
                f2_5=d2&b2           ^ XorValue[2][4][Type[2][4]][Masked_InputIndex]            ;
				...
				f2_9=d3&b3^c3      ^ XorValue[2][8][Type[2][8]][Masked_InputIndex]    ;
				...
				f3_1=d1&b1^d1&c1^1         ^ XorValue[3][0][Type[3][0]][Masked_InputIndex]   ;
                ...
                f3_5= d2&b2^d2&c2          ^ XorValue[3][4][Type[3][4]][Masked_InputIndex] ;
...
ExpressionType[2]= EType_dANDbXORc ; 
ExpressionType[3]= EType_dANDbcXORb ;   
#if 1
for (CoordIndex =0; CoordIndex <4; CoordIndex++)
{   
