...
x:f0 = d   
y:f1 = b&d ^ c&d ^ c^1
z:f2 = a&d ^ b&d ^ c&d ^ b^1
t:f3 = a&d ^ c&d ^ a^1

 f0_0=d1    || f1_0=d1&b1^d1&c1 ^1    ||   f2_0=d1&a1^d1&b1^d1&c1^1         ||  f3_0=d1&a1^d1&c1   ^1
 f0_1=0     || f1_1=d1&b2^d1&c2^c2  ||   f2_1=d1&a2^d1&b2^d1&c2^b2      ||  f3_1=d1&a2^d1&c2^a2
 f0_2=0     || f1_2=d1&b3^d1&c3     ||   f2_2=d1&a3^d1&b3^d1&c3         ||  f3_2=d1&a3^d1&c3   
 f0_3=0     || f1_3=d2&b1^d2&c1^c1  ||   f2_3=d2&a1^d2&b1^d2&c1^b1      ||  f3_3=d2&a1^d2&c1^a1
 f0_4=d2    || f1_4=d2&b2^d2&c2     ||   f2_4=d2&a2^d2&b2^d2&c2         ||  f3_4=d2&a2^d2&c2    
 f0_5= 0    || f1_5=d2&b3^d2&c3     ||   f2_5=d2&a3^d2&b3^d2&c3         ||  f3_5=d2&a3^d2&c3   
 f0_6= 0    || f1_6=d3&b1^d3&c1     ||   f2_6=d3&a1^d3&b1^d3&c1         ||  f3_6=d3&a1^d3&c1   
 f0_7= 0    || f1_7=d3&b2^d3&c2     ||   f2_7=d3&a2^d3&b2^d3&c2         ||  f3_7=d3&a2^d3&c2   
 f0_8=d3    || f1_8=d3&b3^d3&c3^c3  ||   f2_8=d3&a3^d3&b3^d3&c3^b3      ||  f3_8=d3&a3^d3&c3^a3
...
#define D3SameIntuple_c123b123a123  2  // this suits for the case of  d&c^b^a  or d&c^d&b^a
#define D3SameIntuple_c123a123      3  // this suits for the case of  d&c^a
#define NoNeedTable    0
// TableIndex
#define D3SameIntuple_c123b123_Index 3
#define D3SameIntuple_c123a123_Index 3
...
#define  EType_dANDbcXORb        1  //  this suits for the case of  d&b^d&c^b or b&d ^ c&d ^ c
#define  EType_dANDacXORa        2   //  this suits for the case of a&d ^ c&d ^ a
#define  EType_dANDabcXORb       3 //  this suits for the case of a&d ^ b&d ^ c&d ^ b
#define  EType_NoDeal            0 
char FileName[30]="Gen2orderRectangleG.txt";
...
char f2BaseExpression[9][50]=
{{"f2[0]=d1&a1^d1&b1^d1&c1 ^1     "},
 {"f2[1]=d1&a2^d1&b2^d1&c2^b2   "},
 {"f2[2]=d1&a3^d1&b3^d1&c3      "},	
 {"f2[3]=d2&a1^d2&b1^d2&c1^b1   "},	
 {"f2[4]=d2&a2^d2&b2^d2&c2      "},	
 {"f2[5]=d2&a3^d2&b3^d2&c3      "},
 {"f2[6]=d3&a1^d3&b1^d3&c1      "},	
 {"f2[7]=d3&a2^d3&b2^d3&c2      "},	
 {"f2[8]=d3&a3^d3&b3^d3&c3^b3   "}	
};


char f3BaseExpression[9][50]=
{{"f3[0]=d1&a1^d1&c1^1    "},
 {"f3[1]=d1&a2^d1&c2^a2 "},
 {"f3[2]=d1&a3^d1&c3    "},	
 {"f3[3]=d2&a1^d2&c1^a1 "},	
...
/*TableType3
TransLinearItem_d3Sc123a123: d&c^a   c and d is the items  in nolinear items, a is only linear item
        type[0]    type[1]    type[2]    
comp_0     0          a1        c1           
comp_1     0          a2        c2           
comp_2     0          a3        c3           
...
-----------------------------------------
*/
void TransLinearItem_d3Sc123a123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][4],unsigned char*   XorValue[4][9][4]) 
 {
	 unsigned short	Masked_InputIndex,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	  ...
	  for(CompIndex=0;CompIndex<9;CompIndex++)
	   {
		   ...
		   if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
			  ...
			  TransLinearItem[CoordIndex][CompIndex][1]=0x200;//a3  type[1]   for comp2  comp5   comp8
		       TransLinearItem[CoordIndex][CompIndex][2]=0x008;//c3   for comp2  comp5   comp8
               } 
   ...
   for( CoordIndex=0;CoordIndex<4;CoordIndex++)
		{
			...
			else if(TableType[CoordIndex]==D3SameIntuple_c123a123)
				TransLinearItem_d3Sc123a123(CoordIndex,   TransLinearItem, XorValue);
			else
...
d&a^d&c^a
*/
void  InputTableIndexGen_NLdacLa(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(c1<<1)|(d1<<0); 
				//---component 1 

                InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(c2<<1)|(d1<<0); 				
				//---component 2 

				InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(c3<<1)|(d1<<0);  
				 
                //---component 3
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(c1<<1)|(d2<<0);
				 
				 //---component 4 
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(c2<<1)|(d2<<0);
				//---component 5 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(c3<<1)|(d2<<0);
                //---component 6  
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(c1<<1)|(d3<<0);	
				 //---component 7 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(c2<<1)|(d3<<0);
                //---component 8 
          			InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(c3<<1)|(d3<<0);          			
          			Masked_InputIndex++;	
			}
		}
	}
...
a&d ^ b&d ^ c&d ^ b
*/
void  InputTableIndexGen_NLdabcLb(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
...
void MakeLargeTables( unsigned char  Type[4][9], unsigned char*     InputTableIndex[4][9], unsigned char*     F3FullMaskValue[4][3],unsigned char*     F3To1UnMaskValue[4][3],unsigned char*   XorValue[4][9][4],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4],unsigned short  InitTranComLinearItem[4][9],unsigned char ExpressionType[4])
{
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
		if(ExpressionType[CoordIndex]==EType_dANDbcXORb)
			InputTableIndexGen_NLdbcLb(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
		else if(ExpressionType[CoordIndex]== EType_dANDacXORa)
			InputTableIndexGen_NLdacLa(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
		else if(ExpressionType[CoordIndex]==EType_dANDabcXORb )
			InputTableIndexGen_NLdabcLb(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
	 }
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				// coordinate_1
                f1_1=d1&b1^d1&c1 ^1        ^ XorValue[1][0][Type[1][0]][Masked_InputIndex];  
                f1_2=d1&b2^d1&c2^c2        ^ XorValue[1][1][Type[1][1]][Masked_InputIndex] ; 
				f1_3=d1&b3^d1&c3           ^ XorValue[1][2][Type[1][2]][Masked_InputIndex] ; 

				F3FullMaskValue[1][0][Masked_InputIndex]=(f1_3<<2)|(f1_2<<1)|(f1_1<<0);
				F3To1UnMaskValue[1][0][Masked_InputIndex]=f1_1^f1_2^f1_3;

				f1_4=d2&b1^d2&c1^c1   ^ XorValue[1][3][Type[1][3]][Masked_InputIndex];
                f1_5=d2&b2^d2&c2      ^ XorValue[1][4][Type[1][4]][Masked_InputIndex];
				f1_6=d2&b3^d2&c3      ^ XorValue[1][5][Type[1][5]][Masked_InputIndex];
				 
				F3FullMaskValue[1][1][Masked_InputIndex]=(f1_6<<2)|(f1_5<<1)|(f1_4<<0);
				F3To1UnMaskValue[1][1][Masked_InputIndex]=f1_6^f1_5^f1_4;

				f1_7=d3&b1^d3&c1       ^ XorValue[1][6][Type[1][6]][Masked_InputIndex] ;
                f1_8=d3&b2^d3&c2       ^ XorValue[1][7][Type[1][7]][Masked_InputIndex] ;
				f1_9=d3&b3^d3&c3^c3    ^ XorValue[1][8][Type[1][8]][Masked_InputIndex]  ;
				...
				// coordinate_2
			    f2_1=d1&a1^d1&b1^d1&c1^1     ^ XorValue[2][0][Type[2][0]][Masked_InputIndex]   ;
                f2_2=d1&a2^d1&b2^d1&c2^b2  ^ XorValue[2][1][Type[2][1]][Masked_InputIndex]   ;
                f2_3=d1&a3^d1&b3^d1&c3     ^ XorValue[2][2][Type[2][2]][Masked_InputIndex]   ;
				...
				f2_4=d2&a1^d2&b1^d2&c1^b1   ^ XorValue[2][3][Type[2][3]][Masked_InputIndex] ;
                f2_5=d2&a2^d2&b2^d2&c2      ^ XorValue[2][4][Type[2][4]][Masked_InputIndex] ;
                f2_6=d2&a3^d2&b3^d2&c3      ^ XorValue[2][5][Type[2][5]][Masked_InputIndex] ;
				...
				f2_7=d3&a1^d3&b1^d3&c1    ^ XorValue[2][6][Type[2][6]][Masked_InputIndex]   ; 
                f2_8=d3&a2^d3&b2^d3&c2    ^ XorValue[2][7][Type[2][7]][Masked_InputIndex]   ; 
                f2_9=d3&a3^d3&b3^d3&c3^b3 ^ XorValue[2][8][Type[2][8]][Masked_InputIndex]    ; 
				...
				f3_1= d1&a1^d1&c1 ^1     ^ XorValue[3][0][Type[3][0]][Masked_InputIndex];
				f3_2= d1&a2^d1&c2^a2   ^ XorValue[3][1][Type[3][1]][Masked_InputIndex];
				f3_3= d1&a3^d1&c3      ^ XorValue[3][2][Type[3][2]][Masked_InputIndex];
				
				F3FullMaskValue[3][0][Masked_InputIndex]=(f3_3<<2)|(f3_2<<1)|(f3_1<<0);
				F3To1UnMaskValue[3][0][Masked_InputIndex]=f3_1^f3_2^f3_3;

				
				f3_4=d2&a1^d2&c1^a1 ^ XorValue[3][3][Type[3][3]][Masked_InputIndex];
				f3_5=d2&a2^d2&c2    ^ XorValue[3][4][Type[3][4]][Masked_InputIndex];
				f3_6=d2&a3^d2&c3    ^ XorValue[3][5][Type[3][5]][Masked_InputIndex];
				
				
				F3FullMaskValue[3][1][Masked_InputIndex]=(f3_6<<2)|(f3_5<<1)|(f3_4<<0);
				F3To1UnMaskValue[3][1][Masked_InputIndex]=f3_6^f3_5^f3_4;

				 f3_7=d3&a1^d3&c1     ^ XorValue[3][6][Type[3][6]][Masked_InputIndex]   ;
                 f3_8=d3&a2^d3&c2     ^ XorValue[3][7][Type[3][7]][Masked_InputIndex]   ;
                 f3_9=d3&a3^d3&c3^a3  ^ XorValue[3][8][Type[3][8]][Masked_InputIndex]    ;
...
TableType[3]=D3SameIntuple_c123a123;
TableTypeIndex[3]= D3SameIntuple_c123a123_Index;
TableType[2]=D3SameIntuple_c123b123a123;
TableTypeIndex[2]=D3SameIntuple_c123b123a123_Index;
...
ExpressionType[3]= EType_dANDacXORa    ;
ExpressionType[2]= EType_dANDabcXORb   ;
ExpressionType[1]= EType_dANDbcXORb; 
						...
						for(Type[CoordIndex][4]=0;Type[CoordIndex][4]<TableTypeIndex[CoordIndex]; Type[CoordIndex][4]++)
						{
							for(Type[CoordIndex][5]=0;Type[CoordIndex][5]<TableTypeIndex[CoordIndex]; Type[CoordIndex][5]++)
							
			                  {
								 ...
								 if(TableType[CoordIndex]==D3SameIntuple_c123b123a123)
				...
				for(int k=0;k<CaseNum[CoordIndex3];k++)
					{
						...
						for (i=0;i<9;i++)
						  ...
						  fprintf(F, "========================================\n");
						   ...
						   for (i=0;i<9;i++)
						   {
							fprintf(F, "%s  %s; \n",f3BaseExpression[i],f3AddItems[i][Type[CoordIndex0][i]] );
						   }
						   fprintf(F, "========================================\n");
