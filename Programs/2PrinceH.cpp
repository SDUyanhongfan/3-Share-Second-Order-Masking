...
f0_0=d1&b1^d1&c1^a1     || f1_0=d1&b1^a1 ^1           || f2_0=d1&c1^d1          || f3_0= c1
f0_1=d1&b2^d1&c2^b2     || f1_1=d1&b2^c2            || f2_1=d1&c2^b2          || f3_1= 0
f0_2=d1&b3^d1&c3        || f1_2=d1&b3               || f2_2=d1&c3             || f3_2= 0
f0_3=d2&b1^d2&c1^b1     || f1_3=d2&b1^c1            || f2_3=d2&c1^b1          || f3_3= 0
f0_4=d2&b2^d2&c2^a2     || f1_4=d2&b2^a2            || f2_4=d2&c2^d2          || f3_4= c2
f0_5=d2&b3^d2&c3        || f1_5=d2&b3               || f2_5=d2&c3             || f3_5= 0
f0_6=d3&b1^d3&c1        || f1_6=d3&b1               || f2_6=d3&c1             || f3_6= 0
f0_7=d3&b2^d3&c2        || f1_7=d3&b2               || f2_7=d3&c2             || f3_7= 0
f0_8=d3&b3^d3&c3^a3^b3  || f1_8=d3&b3^c3^a3         || f2_8=d3&c3^b3^d3       || f3_8= c3  */
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				f0_1= d1&b1^d1&c1^a1  ^ XorValue[0][0][Type[0][0]][Masked_InputIndex]   ;
				f0_2= d1&b2^d1&c2^b2  ^ XorValue[0][1][Type[0][1]][Masked_InputIndex]   ;
				f0_3= d1&b3^d1&c3     ^ XorValue[0][2][Type[0][2]][Masked_InputIndex]   ;
				
				F3FullMaskValue[0][0][Masked_InputIndex]=(f0_3<<2)|(f0_2<<1)|(f0_1<<0);
				F3To1UnMaskValue[0][0][Masked_InputIndex]=f0_1^f0_2^f0_3;

				f0_4=d2&b1^d2&c1^b1  ^ XorValue[0][3][Type[0][3]][Masked_InputIndex]            ;
				f0_5=d2&b2^d2&c2^a2  ^ XorValue[0][4][Type[0][4]][Masked_InputIndex]            ;
				f0_6=d2&b3^d2&c3     ^ XorValue[0][5][Type[0][5]][Masked_InputIndex]            ;

				F3FullMaskValue[0][1][Masked_InputIndex]=(f0_6<<2)|(f0_5<<1)|(f0_4<<0);
				F3To1UnMaskValue[0][1][Masked_InputIndex]=f0_6^f0_5^f0_4;

				 f0_7=d3&b1^d3&c1        ^ XorValue[0][6][Type[0][6]][Masked_InputIndex]   ;
                 f0_8=d3&b2^d3&c2        ^ XorValue[0][7][Type[0][7]][Masked_InputIndex]   ;
                 f0_9=d3&b3^d3&c3^a3^b3  ^ XorValue[0][8][Type[0][8]][Masked_InputIndex]    ;
				...
				f1_1=d1&b1^a1^1   ^ XorValue[1][0][Type[1][0]][Masked_InputIndex]   ;
                ...
                f1_5=d2&b2^a2   ^ XorValue[1][4][Type[1][4]][Masked_InputIndex]            ;
                ...
                f1_9=d3&b3^c3^a3 ^ XorValue[1][8][Type[1][8]][Masked_InputIndex]    ; 
				F3FullMaskValue[1][2][Masked_InputIndex]=(f1_9<<2)|(f1_8<<1)|(f1_7<<0);
				F3To1UnMaskValue[1][2][Masked_InputIndex]=f1_9^f1_8^f1_7;
				

				// coordinate_2
				f2_1=d1&c1^d1      ^ XorValue[2][0][Type[2][0]][Masked_InputIndex];  
                f2_2=d1&c2^b2        ^ XorValue[2][1][Type[2][1]][Masked_InputIndex] ; 
				...
				f2_4=d2&c1^b1           ^ XorValue[2][3][Type[2][3]][Masked_InputIndex]            ;
                f2_5=d2&c2^d2           ^ XorValue[2][4][Type[2][4]][Masked_InputIndex]            ;
				...
				f2_9=d3&c3^b3^d3      ^ XorValue[2][8][Type[2][8]][Masked_InputIndex]    ;
...
TableType[0]=D3SameIntuple_c123b123a123;
TableTypeIndex[0]= D3SameIntuple_c123b123a123_Index;
TableType[1]=D3SameIntuple_c123b123a123;
TableTypeIndex[1]= D3SameIntuple_c123b123a123_Index;
...
ExpressionType[0]= EType_dANDbcXORab; 
ExpressionType[1]= EType_dANDbXORac; 
