...
f0_0=b1&a1^d1^1 || f1_0=b1&c1^a1       || f2_0=c1      ||  f3_0=b1 ^1   
f0_1=b1&a2^a2   || f1_1=b1&c2^c2        || f2_1=0       || f3_1=0    
f0_2=b1&a3      || f1_2=b1&c3           || f2_2=0       || f3_2=0    
f0_3=b2&a1^a1   || f1_3=b2&c1^c1        || f2_3=0       || f3_3=0    
f0_4=b2&a2      || f1_4=b2&c2           || f2_4=c2      || f3_4=b2     
f0_5=b2&a3^d3   || f1_5=b2&c3^a3        || f2_5=0       || f3_5= 0   
f0_6=b3&a1      || f1_6=b3&c1           || f2_6=0       || f3_6= 0   
f0_7=b3&a2^d2   || f1_7=b3&c2^a2        || f2_7=0       || f3_7= 0   
f0_8=b3&a3^a3   || f1_8=b3&c3^c3        || f2_8=c3      || f3_8=b3    
...
//TableType
#define B3SameIntuple_a123d123      1  // this suits for  the case of b&a ^ a ^d ^1
#define B3SameIntuple_a123c123      2  // this suits for the case of  d&b^a
#define NoNeedTable    0
// TableIndex
#define B3SameIntuple_a123d123_Index 3
#define B3SameIntuple_a123c123_Index   3
#define  NoNeedTable_Index 0


//ExpressionType
#define  EType_bANDaXORd         1  //  this suits for  the case of b&a ^ a ^d ^1
#define  EType_bANDcXORa         2  //  this suits for the case of  b&c ^ c^a
...
char FileName[30]="Gen2orderRectangleF.txt";
...
/*TableType1
TransLinearItem_b3Sa123d123:   this   table  siuts  for  b&a ^ a ^d ^1
...
|(b2<<7)|(b3<<6)|(c1<<5)|(c2<<4)    |(c3<<3)|(d1<<2)|(d2<<1)|(d3<<0); e.g. if a1=1：TransLinearItem[][][]=0x800, then this means that  the  item of "a1"  will used in the transformation  
*/

void TransLinearItem_b3Sa123d123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][4],unsigned char*   XorValue[4][9][4]) 
 {
	     ...
	     for(CompIndex=0;CompIndex<9;CompIndex++)
	   {
		   ...
		   if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
			  ...
			  TransLinearItem[CoordIndex][CompIndex][1]=0x800  ; //a1   type[1]   for comp0  comp3   comp6
		       TransLinearItem[CoordIndex][CompIndex][2]= 0x004  ; //d1  type[2]   for comp0  comp3   comp6
			  } 
		  else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
			  { 
			  TransLinearItem[CoordIndex][CompIndex][1]=0x400   ; // a2  type[1]   for comp1  comp4   comp7
		       TransLinearItem[CoordIndex][CompIndex][2]=0x002    ; //d2  type[2]   for comp1  comp4   comp7
              } 
		  else 
			  { 
			  TransLinearItem[CoordIndex][CompIndex][1]=0x200;//a3  type[1]   for comp2  comp5   comp8
		       TransLinearItem[CoordIndex][CompIndex][2]=0x001;//d3  type[2]   for comp2  comp5   comp8
               } 
	   }
...
/*TableType2
TransLinearItem_b3Sa123c123: b&c ^ c^a  
        type[0]    type[1]    type[2]    
comp_0     0          a1        c1            
comp_1     0          a2        c2            
comp_2     0          a3        c3            
...
*/
void TransLinearItem_b3Sa123c123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][4],unsigned char*   XorValue[4][9][4]) 
 {
	 unsigned short	Masked_InputIndex,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
...
)// InitLinearItem1[CompIndex]:CompIndex:0-8;  TransLinearItem[CompIndex][Type]:Type:0-7, XorValue[CompIndex][Type][Masked_InputIndex]: Masked_InputIndex:0-4095.
{
   ...
   for( CoordIndex=0;CoordIndex<4;CoordIndex++)
		{
			if(TableType[CoordIndex]==B3SameIntuple_a123d123)
			   TransLinearItem_b3Sa123d123(CoordIndex,   TransLinearItem, XorValue);
			else if(TableType[CoordIndex]==B3SameIntuple_a123c123)
			    TransLinearItem_b3Sa123c123(CoordIndex,   TransLinearItem, XorValue);
			else
...
void InputTableIndexGen_NLbaLd( unsigned char  Type[4][9], unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{	
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				d3=(a3b3c3d3>>3)&0x01;
				//---component 0
                if ((InitTranComLinearItem[CoordIndex][0] &0x007)==0x004)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d1<<0)|(a1<<3)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][0] &0x007)==0x002)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d2<<0)|(a1<<3)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][0] &0x007)==0x001)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d3<<0)|(a1<<3)|(b1<<2); 
				 else 
					 InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(b1<<2); 
				
				//---component 1
				if ((InitTranComLinearItem[CoordIndex][1] &0x007)==0x004)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(d1<<0)|(a2<<3)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][1] &0x007)==0x002)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(d2<<0)|(a2<<3)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0x007)==0x001)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(d3<<0)|(a2<<3)|(b1<<2); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(b1<<2); 	
									
				//---component 2 
				if ((InitTranComLinearItem[CoordIndex][2] &0x007)==0x004)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(d1<<0)|(a3<<3)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][2] &0x007)==0x002)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(d2<<0)|(a3<<3)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0x007)==0x001)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(d3<<0)|(a3<<3)|(b1<<2);  
				else
					 InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(b1<<2);  
				 
                //---component 3
				if ((InitTranComLinearItem[CoordIndex][3] &0x007)==0x004)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(d1<<0)|(a1<<3)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][3] &0x007)==0x002)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(d2<<0)|(a1<<3)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0x007)==0x001)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(d3<<0)|(a1<<3)|(b2<<2);  
				else
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(b2<<2); 
				 
				 //---component 4

				if ((InitTranComLinearItem[CoordIndex][4] &0x007)==0x004)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d1<<0)|(a2<<3)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][4] &0x007)==0x002)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d2<<0)|(a2<<3)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0x007)==0x001)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d3<<0)|(a2<<3)|(b2<<2);
				 else
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(b2<<2); 
				//---component 5
				if ((InitTranComLinearItem[CoordIndex][5] &0x007)==0x004)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(d1<<0)|(a3<<3)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][5] &0x007)==0x002)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(d2<<0)|(a3<<3)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0x007)==0x001)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(d3<<0)|(a3<<3)|(b2<<2);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(b2<<2);

                //---component 6
				if ((InitTranComLinearItem[CoordIndex][6] &0x007)==0x004)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(d1<<0)|(a1<<3)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][6] &0x007)==0x002)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(d2<<0)|(a1<<3)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0x007)==0x001)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(d3<<0)|(a1<<3)|(b3<<2);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(b3<<2);		
				 //---component 7
				if ((InitTranComLinearItem[CoordIndex][7] &0x007)==0x004)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(d1<<0)|(a2<<3)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][7] &0x007)==0x002)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(d2<<0)|(a2<<3)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0x007)==0x001)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(d3<<0)|(a2<<3)|(b3<<2);
				else 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(b3<<2);
                //---component 8
				if ((InitTranComLinearItem[CoordIndex][8] &0x007)==0x004)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d1<<0)|(a3<<3)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][8] &0x007)==0x002)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d2<<0)|(a3<<3)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][8] &0x007)==0x001)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d3<<0)|(a3<<3)|(b3<<2);
				else 
          			InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(b3<<2);
          			Masked_InputIndex++;
			}
		}
	}
...
void InputTableIndexGen_NLbcLa(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{	
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a1<<3)|(c2<<1)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(c2<<1)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a3<<3)|(c2<<1)|(b1<<2); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(c2<<1)|(b1<<2); 				
				//---component 2  
				if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a1<<3)|(c3<<1)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a2<<3)|(c3<<1)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(c3<<1)|(b1<<2);  
				else
					 InputTableIndex[CoordIndex][2][Masked_InputIndex]=(c3<<1)|(b1<<2);  
				 
                //---component 3  
				if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(c1<<1)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a2<<3)|(c1<<1)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a3<<3)|(c1<<1)|(b2<<2);  
				else
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(c1<<1)|(b2<<2);
				...
				if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a1<<3)|(c3<<1)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a2<<3)|(c3<<1)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(c3<<1)|(b2<<2);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(c3<<1)|(b2<<2);

                //---component 6  
				if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(c1<<1)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a2<<3)|(c1<<1)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a3<<3)|(c1<<1)|(b3<<2);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(c1<<1)|(b3<<2);	
				 //---component 7  
				if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a1<<3)|(c2<<1)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(c2<<1)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a3<<3)|(c2<<1)|(b3<<2);
				else 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(c2<<1)|(b3<<2);
                //---component 8 
...
void MakeLargeTables( unsigned char  Type[4][9], unsigned char*     InputTableIndex[4][9], unsigned char*     F3FullMaskValue[4][3],unsigned char*     F3To1UnMaskValue[4][3],unsigned char*   XorValue[4][9][4],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4],unsigned short  InitTranComLinearItem[4][9],unsigned char ExpressionType[4])
{
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
		if(ExpressionType[CoordIndex]== EType_bANDaXORd )
			InputTableIndexGen_NLbaLd(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				CoordIndex=3;
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2);
				InputTableIndex[CoordIndex][1][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][2][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][3][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2);
				InputTableIndex[CoordIndex][5][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][6][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][7][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][8][Masked_InputIndex]=(b3<<2);
				...
				f0_1= b1&a1^d1 ^1 ^ XorValue[0][0][Type[0][0]][Masked_InputIndex]   ;
				f0_2= b1&a2^a2    ^ XorValue[0][1][Type[0][1]][Masked_InputIndex]   ;
				f0_3= b1&a3       ^ XorValue[0][2][Type[0][2]][Masked_InputIndex]   ;
				
				F3FullMaskValue[0][0][Masked_InputIndex]=(f0_3<<2)|(f0_2<<1)|(f0_1<<0);
				F3To1UnMaskValue[0][0][Masked_InputIndex]=f0_1^f0_2^f0_3;

				
				f0_4=b2&a1^a1  ^ XorValue[0][3][Type[0][3]][Masked_InputIndex]            ;
				f0_5=b2&a2     ^ XorValue[0][4][Type[0][4]][Masked_InputIndex]            ;
				f0_6=b2&a3^d3  ^ XorValue[0][5][Type[0][5]][Masked_InputIndex]            ;
				
				
				F3FullMaskValue[0][1][Masked_InputIndex]=(f0_6<<2)|(f0_5<<1)|(f0_4<<0);
				F3To1UnMaskValue[0][1][Masked_InputIndex]=f0_6^f0_5^f0_4;

				 f0_7=b3&a1      ^ XorValue[0][6][Type[0][6]][Masked_InputIndex]   ;
                 f0_8=b3&a2^d2   ^ XorValue[0][7][Type[0][7]][Masked_InputIndex]   ;
                 f0_9=b3&a3^a3   ^ XorValue[0][8][Type[0][8]][Masked_InputIndex]    ;
				...
				f1_1=b1&c1^a1    ^ XorValue[1][0][Type[1][0]][Masked_InputIndex]   ;
                f1_2=b1&c2^c2    ^ XorValue[1][1][Type[1][1]][Masked_InputIndex]   ;
                f1_3=b1&c3       ^ XorValue[1][2][Type[1][2]][Masked_InputIndex]   ;
				...
				f1_4=b2&c1^c1^ XorValue[1][3][Type[1][3]][Masked_InputIndex]            ;
                f1_5=b2&c2   ^ XorValue[1][4][Type[1][4]][Masked_InputIndex]            ;
                f1_6=b2&c3^a3^ XorValue[1][5][Type[1][5]][Masked_InputIndex]            ;
				...
				f1_7=b3&c1     ^ XorValue[1][6][Type[1][6]][Masked_InputIndex]   ; 
                f1_8=b3&c2^a2  ^ XorValue[1][7][Type[1][7]][Masked_InputIndex]   ; 
                f1_9=b3&c3^c3  ^ XorValue[1][8][Type[1][8]][Masked_InputIndex]    ; 
...
TableType[0]=B3SameIntuple_a123d123;
TableTypeIndex[0]= B3SameIntuple_a123d123_Index;
TableType[1]=B3SameIntuple_a123c123;
TableTypeIndex[1]= B3SameIntuple_a123c123_Index;
TableType[2]=NoNeedTable;
TableTypeIndex[2]= NoNeedTable_Index;
...
ExpressionType[0]= EType_bANDaXORd   ;
ExpressionType[1]= EType_bANDcXORa ;
ExpressionType[2]= EType_NoDeal; 
