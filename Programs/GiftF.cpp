...
f0_0=d1    || f1_0=c1&b1^c1&a1^a1   || f2_0=c1&b1 ^a1^1   || f3_0=c1^1      
f0_1=0     || f1_1=c1&b2^c1&a2^c1   || f2_1=c1&b2 ^c1     || f3_1=        
f0_2=0     || f1_2=c1&b3^c1&a3      || f2_2=c1&b3 ^b3     || f3_2=        
f0_3=0     || f1_3=c2&b1^c2&a1      || f2_3=c2&b1 ^b1     || f3_3=        
f0_4=d2    || f1_4=c2&b2^c2&a2^a2   || f2_4=c2&b2 ^a2     || f3_4=c2        
f0_5= 0    || f1_5=c2&b3^c2&a3^c2   || f2_5=c2&b3 ^c2     || f3_5=        
f0_6= 0    || f1_6=c3&b1^c3&a1      || f2_6=c3&b1 ^c3     || f3_6=        
f0_7= 0    || f1_7=c3&b2^c3&a2^c3   || f2_7=c3&b2 ^b2     || f3_7=        
f0_8=d3    || f1_8=c3&b3^c3&a3^a3   || f2_8=c3&b3 ^a3     || f3_8=c3     
*/
...
//TableType
#define C3SameIntuple_a123b123 2  // b&c^b^c^a^1;
#define C3SameIntuple_abd123   1    //b&c^a&c^a^c ;

#define NoNeedTable    0

// TableIndex

#define C3SameIntuple_a123b123_Index  3
#define C3SameIntuple_abd123_Index  4


#define  NoNeedTable_Index 0

//ExpressionType
#define  EType_cANDbaXORac         1   //  this suits for the case of b&c^a&c^a^c
#define  EType_cANDbXORac         2   //  this suits for the case of  b&c^b^c^a^1;
...
char FileName[30]="Gen2orderForGiftF.txt";
...
f1 = b&c^a&c^a^c ;
 f2 = b&c^b^c^a^1;
TransLinearItem[][][]=(a1<<8)| (a2<<7)|(a3<<6)|(b1<<8)
| (b2<<7)|(b3<<6)|(c1<<5)|(c2<<4)

|(c3<<3)|(d1<<2)|(d2<<1)|(d3<<0); 
e.g. if b1=1：TransLinearItem[][][]=0x100, then this means that  the  item of "b1"  will used in the transformation  
*/
void TransLinearItem_c3Sb123a123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][7],unsigned char*   XorValue[4][9][7]) 
 {
...
//the XOR values of  linear items  in the all possible composed items.		
                ...
                for(CompIndex=0;CompIndex<9;CompIndex++)
	               {
	            	...
	            	if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
	            		  { 
	            	       ...
	            	       XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=b1  ; //b1  type[3]   for comp0  comp1   comp2
	            		  } 
	            	else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
	            		  { 
						   XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a2  ; // a2  type[1]   for comp1  comp4   comp7
	            	       XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=b2 ; //b2  type[2]   for comp3  comp4   comp5
	            	       } 
	            	else 
	            		   {
						    XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a3;//a3  type[1]   for comp2  comp5   comp8
	            	        XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=b3;//b3  type[2]   for comp6  comp7   comp8  
	            	       } 
	               }
 ...
 /*TableType2
TransLinearItem_c3Sabd123: bd^cd^b  b and d is the items  in nolinear items, a is only linear item
...
--------------------------------------------------
*/
void TransLinearItem_c3Sabd123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][7],unsigned char*   XorValue[4][9][7]) 
 {
	 ...
	 // the linear items  in the all possible composed items in our bebuiled Table.	
	   for(CompIndex=0;CompIndex<9;CompIndex++)
	   {
		   ...
		   if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
			  ...
			  TransLinearItem[CoordIndex][CompIndex][1]=0x800  ; //a1      type[1]   for comp0  comp3   comp6
		      TransLinearItem[CoordIndex][CompIndex][2]= 0x100  ; //b1     type[2]   for comp0  comp3   comp6
			  TransLinearItem[CoordIndex][CompIndex][3]= 0x004  ; //d1     type[3]   for comp0  comp3   comp6
			  } 
		  else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
			  { 
			  TransLinearItem[CoordIndex][CompIndex][1]=0x400   ;  //a2    type[1]   for comp1  comp4   comp7
		      TransLinearItem[CoordIndex][CompIndex][2]=0x080    ; //b2     type[2]   for comp1  comp4   comp7
			  TransLinearItem[CoordIndex][CompIndex][3]=0x002    ; //d2     type[3]   for comp1  comp4   comp7
              } 
		  else 
			  { 
			  TransLinearItem[CoordIndex][CompIndex][1]=0x200;//a3     type[1]   for comp2  comp5   comp8
		      TransLinearItem[CoordIndex][CompIndex][2]=0x040;//b3     type[2]   for comp2  comp5   comp8
			  TransLinearItem[CoordIndex][CompIndex][3]=0x001;//d3     type[3]   for comp2  comp5   comp8
               } 
	   } 
                ...
                for(CompIndex=0;CompIndex<9;CompIndex++)
	               {
	            	...
	            	if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
	            		  { 
						   ...
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]= d1  ; //d1  type[3]   for comp0  comp3   comp6
	            		  } 
	            	else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
	            		  { 
						   XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a2       ; //a2     type[1]   for comp1  comp4   comp7
	            	       XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=b2       ; //b2     type[2]   for comp1  comp4   comp7
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]=d2       ; //d2     type[3]   for comp1  comp4   comp7
	            	       } 
	            	else 
	            		   {
						   XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a3;   //a3     type[1]   for comp2  comp5   comp8
	            	       XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=b3;   //b3     type[2]   for comp2  comp5   comp8
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]=d3;   //d3     type[3]   for comp2  comp5   comp8
	            	       } 
...
)// InitLinearItem1[CompIndex]:CompIndex:0-8;  TransLinearItem[CompIndex][Type]:Type:0-7, XorValue[CompIndex][Type][Masked_InputIndex]: Masked_InputIndex:0-4095.
{
    ...
    for( CoordIndex=0;CoordIndex<4;CoordIndex++)
		{
			 if(TableType[CoordIndex]==C3SameIntuple_a123b123)
			    TransLinearItem_c3Sb123a123(CoordIndex,   TransLinearItem, XorValue);
			
			 else if(TableType[CoordIndex]==C3SameIntuple_abd123)
				TransLinearItem_c3Sabd123(CoordIndex,   TransLinearItem, XorValue);
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
                ...
                if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(c1<<1)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a2<<3)|(c1<<1)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a3<<3)|(c1<<1)|(b1<<2); 
				else 
					 InputTableIndex[CoordIndex][0][Masked_InputIndex]=(c1<<1)|(b1<<2); 
				//---component 1 d1b2
				if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a1<<3)|(c1<<1)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(c1<<1)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a3<<3)|(c1<<1)|(b2<<2); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(c1<<1)|(b2<<2); 				
				//---component 2  d1b3
				if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a1<<3)|(c1<<1)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a2<<3)|(c1<<1)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(c1<<1)|(b3<<2);  
				else
					 InputTableIndex[CoordIndex][2][Masked_InputIndex]=(c1<<1)|(b3<<2);  
				 
                //---component 3  d2b1+a2  
				if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(c2<<1)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a2<<3)|(c2<<1)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a3<<3)|(c2<<1)|(b1<<2);  
				else
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(c2<<1)|(b1<<2);
				 
				 //---component 4 d2b2

				if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a1<<3)|(c2<<1)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(c2<<1)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a3<<3)|(c2<<1)|(b2<<2);
				 else
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(c2<<1)|(b2<<2);
				//---component 5 d2b3
				if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a1<<3)|(c2<<1)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a2<<3)|(c2<<1)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(c2<<1)|(b3<<2);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(c2<<1)|(b3<<2);

                //---component 6   d3b1+a3 
				if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(c3<<1)|(b1<<2);
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a2<<3)|(c3<<1)|(b1<<2); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a3<<3)|(c3<<1)|(b1<<2);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(c3<<1)|(b1<<2);	
				 //---component 7  d3b2
				if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a1<<3)|(c3<<1)|(b2<<2);
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(c3<<1)|(b2<<2); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a3<<3)|(c3<<1)|(b2<<2);
				else 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(c3<<1)|(b2<<2);
                //---component 8 d3b3
				if ((InitTranComLinearItem[CoordIndex][8] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a1<<3)|(c3<<1)|(b3<<2);
				else if ((InitTranComLinearItem[CoordIndex][8] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a2<<3)|(c3<<1)|(b3<<2); 
				else if ((InitTranComLinearItem[CoordIndex][8] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(c3<<1)|(b3<<2);
				else 
          			InputTableIndex[CoordIndex][8][Masked_InputIndex]=(c3<<1)|(b3<<2);
          		#endif
...
*/
void  InputTableIndexGen_NLcbaLac(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7])
{
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				#if 1
                //---component 0  
                if ((InitTranComLinearItem[CoordIndex][0] & 0x003)==0x004)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d1<<0)|(a1<<3)|(b1<<2)|(c1<<1);
				else if ((InitTranComLinearItem[CoordIndex][0] & 0x003)==0x002)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d2<<0)|(a1<<3)|(b1<<2)|(c1<<1); 
				else if ((InitTranComLinearItem[CoordIndex][0] & 0x003)==0x001)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d3<<0)|(a1<<3)|(b1<<2)|(c1<<1); 
				else 
					 InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c1<<1); 
				//---component 1 
				if ((InitTranComLinearItem[CoordIndex][1] &0x003)==0x004)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(d1<<0)|(a2<<3)|(b2<<2)|(c1<<1);
				else if ((InitTranComLinearItem[CoordIndex][1] &0x003)==0x002)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(d2<<0)|(a2<<3)|(b2<<2)|(c1<<1); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0x003)==0x001)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(d3<<0)|(a2<<3)|(b2<<2)|(c1<<1); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c1<<1);
				//---component 2  
				if ((InitTranComLinearItem[CoordIndex][2] &0x003)==0x004)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(d1<<0)|(a3<<3)|(b3<<2)|(c1<<1);
				else if ((InitTranComLinearItem[CoordIndex][2] &0x003)==0x002)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(d2<<0)|(a3<<3)|(b3<<2)|(c1<<1); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0x003)==0x001)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(d3<<0)|(a3<<3)|(b3<<2)|(c1<<1);  
				else
					 InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c1<<1);  
				 
                //---component 3   
				if ((InitTranComLinearItem[CoordIndex][3] &0x003)==0x004)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(d1<<0)|(a1<<3)|(b1<<2)|(c2<<1);
				else if ((InitTranComLinearItem[CoordIndex][3] &0x003)==0x002)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(d2<<0)|(a1<<3)|(b1<<2)|(c2<<1); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0x003)==0x001)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(d3<<0)|(a1<<3)|(b1<<2)|(c2<<1);  
				else
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c2<<1);
				 
				 //---component 4 

				if ((InitTranComLinearItem[CoordIndex][4] &0x003)==0x004)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d1<<0)|(a2<<3)|(b2<<2)|(c2<<1);
				else if ((InitTranComLinearItem[CoordIndex][4] &0x003)==0x002)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d2<<0)|(a2<<3)|(b2<<2)|(c2<<1); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0x003)==0x001)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d3<<0)|(a2<<3)|(b2<<2)|(c2<<1);
				 else
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c2<<1);
				//---component 5 
				if ((InitTranComLinearItem[CoordIndex][5] &0x003)==0x004)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(d1<<0)|(a3<<3)|(b3<<2)|(c2<<1);
				else if ((InitTranComLinearItem[CoordIndex][5] &0x003)==0x002)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(d2<<0)|(a3<<3)|(b3<<2)|(c2<<1); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0x003)==0x001)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(d3<<0)|(a3<<3)|(b3<<2)|(c2<<1);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c2<<1);

                //---component 6  
				if ((InitTranComLinearItem[CoordIndex][6] &0x003)==0x004)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(d1<<0)|(a1<<3)|(b1<<2)|(c3<<1);
				else if ((InitTranComLinearItem[CoordIndex][6] &0x003)==0x002)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(d2<<0)|(a1<<3)|(b1<<2)|(c3<<1); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0x003)==0x001)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(d3<<0)|(a1<<3)|(b1<<2)|(c3<<1);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c3<<1);	
				 //---component 7 
				if ((InitTranComLinearItem[CoordIndex][7] &0x003)==0x004)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(d1<<0)|(a2<<3)|(b2<<2)|(c3<<1);
				else if ((InitTranComLinearItem[CoordIndex][7] &0x003)==0x002)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(d2<<0)|(a2<<3)|(b2<<2)|(c3<<1); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0x003)==0x001)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(d3<<0)|(a2<<3)|(b2<<2)|(c3<<1);
				else 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c3<<1);
                //---component 8
				if ((InitTranComLinearItem[CoordIndex][8] &0x003)==0x004)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d1<<0)|(a3<<3)|(b3<<2)|(c3<<1);
				else if ((InitTranComLinearItem[CoordIndex][8] &0x003)==0x002)
				    InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d2<<0)|(a3<<3)|(b3<<2)|(c3<<1); 
				else if ((InitTranComLinearItem[CoordIndex][8] &0x003)==0x001)
				    InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d3<<0)|(a3<<3)|(b3<<2)|(c3<<1);
				else 
                    InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c3<<1);
          		#endif
          			Masked_InputIndex++;	
			}
		}
...
void MakeLargeTables( unsigned char  Type[4][9], unsigned char*     InputTableIndex[4][9], unsigned char*     F3FullMaskValue[4][3],unsigned char*     F3To1UnMaskValue[4][3],unsigned char*   XorValue[4][9][7],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7],unsigned short  InitTranComLinearItem[4][9],unsigned char ExpressionType[4])
{
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
	 if(ExpressionType[CoordIndex]==EType_cANDbXORac)
			InputTableIndexGen_NLbcLa(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
	 else if( ExpressionType[CoordIndex]==EType_cANDbaXORac)
		InputTableIndexGen_NLcbaLac(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				CoordIndex=0;
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d1<<0);
				...
				InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d2<<0);
				...
				InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d3<<0);	
				
				
				// coordinate_3

				CoordIndex=3;
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=(c1<<1);
				InputTableIndex[CoordIndex][1][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][2][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][3][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][4][Masked_InputIndex]=(c2<<1);
				InputTableIndex[CoordIndex][5][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][6][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][7][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][8][Masked_InputIndex]=(c3<<1);	
	            ...
	            // coordinate_1
			    f1_1=c1&b1^c1&a1^a1       ^ XorValue[1][0][Type[1][0]][Masked_InputIndex];     
				f1_2=c1&b2^c1&a2^c1       ^ XorValue[1][1][Type[1][1]][Masked_InputIndex] ;    
				f1_3=c1&b3^c1&a3          ^ XorValue[1][2][Type[1][2]][Masked_InputIndex] ;    
                f1_4=c2&b1^c2&a1          ^ XorValue[1][3][Type[1][3]][Masked_InputIndex];     
                f1_5=c2&b2^c2&a2^a2       ^ XorValue[1][4][Type[1][4]][Masked_InputIndex];     
                f1_6=c2&b3^c2&a3^c2       ^ XorValue[1][5][Type[1][5]][Masked_InputIndex];     
			    f1_7=c3&b1^c3&a1          ^ XorValue[1][6][Type[1][6]][Masked_InputIndex];    
				f1_8=c3&b2^c3&a2^c3       ^ XorValue[1][7][Type[1][7]][Masked_InputIndex];    
				f1_9=c3&b3^c3&a3^a3       ^ XorValue[1][8][Type[1][8]][Masked_InputIndex] ;
				...
				f2_1=c1&b1 ^a1 ^1   ^ XorValue[2][0][Type[2][0]][Masked_InputIndex]  ;
				f2_2=c1&b2 ^c1      ^ XorValue[2][1][Type[2][1]][Masked_InputIndex]  ;
				f2_3=c1&b3 ^b3      ^ XorValue[2][2][Type[2][2]][Masked_InputIndex]  ;
				f2_4=c2&b1 ^b1      ^ XorValue[2][3][Type[2][3]][Masked_InputIndex]  ;
				f2_5=c2&b2 ^a2      ^ XorValue[2][4][Type[2][4]][Masked_InputIndex]  ;
				f2_6=c2&b3 ^c2      ^ XorValue[2][5][Type[2][5]][Masked_InputIndex]  ;
				f2_7=c3&b1 ^c3      ^ XorValue[2][6][Type[2][6]][Masked_InputIndex]  ;
				f2_8=c3&b2 ^b2      ^ XorValue[2][7][Type[2][7]][Masked_InputIndex]  ;
                f2_9=c3&b3 ^a3      ^ XorValue[2][8][Type[2][8]][Masked_InputIndex]  ;
...
void	 Type0To2GenerateTypeNumber( unsigned char Coordinate ,  unsigned char CompIndex,      unsigned char  Type[4][9] ,unsigned char  TypeRage[4][9][7],  unsigned char  TypeN[4][9],unsigned char  TypeRageNum[4][9])
{
    ...
    if((Type[Coordinate][ RelateCompIndex1 ]==1)&&(Type[Coordinate][ RelateCompIndex2 ]==1))
		...
		else if(((Type[Coordinate][ RelateCompIndex1 ]==1)&&(Type[Coordinate][ RelateCompIndex2 ]==0)) ||((Type[Coordinate][ RelateCompIndex1 ]==0)&&(Type[Coordinate][ RelateCompIndex2 ]==1)))
		{
		...
		else if(((Type[Coordinate][ RelateCompIndex1 ]==2)&&(Type[Coordinate][ RelateCompIndex2 ]==0)) ||((Type[Coordinate][ RelateCompIndex1 ]==0)&&(Type[Coordinate][ RelateCompIndex2 ]==2)))
		{
...
void	 Type0To3GenerateTypeNumber( unsigned char Coordinate ,  unsigned char CompIndex,      unsigned char  Type[4][9] ,unsigned char  TypeRage[4][9][7],  unsigned char  TypeN[4][9],unsigned char  TypeRageNum[4][9])
{
    unsigned char RelateCompIndex1,RelateCompIndex2;
	if(CompIndex==6)
	{
...
TableType[2]=C3SameIntuple_a123b123;;
TableTypeIndex[2]=C3SameIntuple_a123b123_Index;

TableType[1]     =C3SameIntuple_abd123;
TableTypeIndex[1]=C3SameIntuple_abd123_Index;


TableType[0]=NoNeedTable;
TableTypeIndex[0]= NoNeedTable_Index;

TableType[3]=NoNeedTable;
TableTypeIndex[3]= NoNeedTable_Index;
...
ExpressionType[2]= EType_cANDbXORac  ;
ExpressionType[1]= EType_cANDbaXORac ;
  


ExpressionType[0]= EType_NoDeal;   
ExpressionType[3]= EType_NoDeal;   
							...
							for(Type[CoordIndex][5]=0;Type[CoordIndex][5]<TableTypeIndex[CoordIndex]; Type[CoordIndex][5]++)
			                  {
								 ...
								 if(TableType[CoordIndex]==C3SameIntuple_a123b123)
								      Type0To2GenerateTypeNumber(CoordIndex,6, Type ,TypeRage,   TypeN,TypeRageNum);  
									   ...
									   Type0To3GenerateTypeNumber(CoordIndex,6, Type ,TypeRage,   TypeN,TypeRageNum);  
						 	    ...
						 	    for(TypeN[CoordIndex][6]=0;TypeN[CoordIndex][6]<TypeRageNum[CoordIndex][6]; TypeN[CoordIndex][6]++)
			                    {
			                        Type[CoordIndex][6]=TypeRage[CoordIndex][6][TypeN[CoordIndex][6]];
									 ...
									 if(TableType[CoordIndex]==C3SameIntuple_a123b123)
									   ...
									   Type0To3GenerateTypeNumber(CoordIndex,7, Type ,TypeRage,   TypeN,TypeRageNum);  
									...
									for(TypeN[CoordIndex][7]=0;TypeN[CoordIndex][7]<TypeRageNum[CoordIndex][7]; TypeN[CoordIndex][7]++)
									{
										...
										if(TableType[CoordIndex]==C3SameIntuple_a123b123)
									       ...
									       Type0To3GenerateTypeNumber(CoordIndex,8, Type ,TypeRage,   TypeN,TypeRageNum);  
				...
				for(int k=0;k<CaseNum[CoordIndex3];k++)
					{
						...
						fprintf(F, "========================================\n"); 
						  ...
						  fprintf(F, "========================================\n");
						   for (i=0;i<9;i++)
						   {
							fprintf(F, "%s  %s ; \n",f1BaseExpression[i],  f1AddItems[i][Type[CoordIndex0][i]]);
						   }
						  fprintf(F, "========================================\n");
							 for (i=0;i<9;i++)
						   {
