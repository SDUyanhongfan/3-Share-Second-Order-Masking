...
/*PrinceF*/
/*
f0=d; f1=c,f2=cd+b+1,f3=db+a+1;

f0_0=d1 || f1_0=c1  || f2_0=d1&c1^b1^1    || f3_0=d1&b1^a1^1
f0_1=0  || f1_1=0   || f2_1=d1&c2         || f3_1=d1&b2     
f0_2=0  || f1_2=0   || f2_2=d1&c3         || f3_2=d1&b3     
f0_3=d2 || f1_3=c2  || f2_3=d2&c1         || f3_3=d2&b1  
f0_4=0  || f1_4=0   || f2_4=d2&c2^b2      || f3_4=d2&b2^a2     
f0_5=0  || f1_5=0   || f2_5=d2&c3         || f3_5=d2&b3     
f2_6=d3 || f1_6=c3  || f2_6=d3&c1         || f3_6=d3&b1 
f0_7=0  || f1_7=0   || f2_7=d3&c2         || f3_7=d3&b2     
f0_8=0  || f1_8=0   || f2_8=d3&c3^b3      || f3_8=d3&b3^a3      
...
//ExpressionType
#define  EType_dANDcXORb         1  //  this suits for  the case of d&c^b
#define  EType_dANDbXORa         2  //  this suits for the case of  d&b^a
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
		...
		else if(ExpressionType[CoordIndex]==EType_dANDbXORa)
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				f2_1=d1&c1^b1^1  ^ XorValue[2][0][Type[2][0]][Masked_InputIndex];  
				...
				f3_1=d1&b1^1 ^a1 ^ XorValue[3][0][Type[3][0]][Masked_InputIndex]   ;
				f3_2=d1&b2       ^ XorValue[3][1][Type[3][1]][Masked_InputIndex]   ;
				f3_3=d1&b3       ^ XorValue[3][2][Type[3][2]][Masked_InputIndex]   ;
                ...
                f3_4= d2&b1    ^ XorValue[3][3][Type[3][3]][Masked_InputIndex] ;
                f3_5= d2&b2 ^a2       ^ XorValue[3][4][Type[3][4]][Masked_InputIndex] ;
                f3_6= d2&b3     ^ XorValue[3][5][Type[3][5]][Masked_InputIndex] ;
                ...
                f3_7=d3&b1^ XorValue[3][6][Type[3][6]][Masked_InputIndex]  ;
                f3_8=d3&b2      ^ XorValue[3][7][Type[3][7]][Masked_InputIndex]  ;
                f3_9=d3&b3 ^a3   ^ XorValue[3][8][Type[3][8]][Masked_InputIndex]  ;		
...
ExpressionType[3]= EType_dANDbXORa;   
