...
f3 = b&d ^ c&d ^ b   
 ...
 f3_0=d1&b1^d1&c1^b1   || f2_0=b1&c1 ^ a1 || f1_0=d1    ||f0_0=b1&d1 ^ c1      
 f3_1=d1&b2^d1&c2      || f2_1=b1&c2      || f1_1=0     ||f0_1=b2&d1          
 f3_2=d1&b3^d1&c3      || f2_2=b1&c3      || f1_2=0     ||f0_2=b3&d1          
 f3_3=d2&b1^d2&c1      || f2_3=b2&c1      || f1_3=0     ||f0_3=b1&d2          
 f3_4=d2&b2^d2&c2^b2   || f2_4=b2&c2 ^ a2 || f1_4=d2    ||f0_4=b2&d2^ c2        
 f3_5=d2&b3^d2&c3      || f2_5=b2&c3      || f1_5= 0    ||f0_5=b3&d2          
 f3_6=d3&b1^d3&c1      || f2_6=b3&c1      || f1_6= 0    ||f0_6=b1&d3          
 f3_7=d3&b2^d3&c2      || f2_7=b3&c2      || f1_7= 0    ||f0_7=b2&d3          
 f3_8=d3&b3^d3&c3^b3   || f2_8=b3&c3 ^ a3 || f1_8=d3    ||f0_8=b3&d3 ^ c3     
...
//TableType
#define B3SameIntuple_c123a123      1  // this suits for the case of  c&b^a
#define D3SameIntuple_c123b123a123OneTwo 2
#define NoNeedTable    0

// TableIndex
#define B3SameIntuple_c123a123_Index   3
#define  D3SameIntuple_c123b123a123OneTwo_Index 7
#define  NoNeedTable_Index 0

//ExpressionType
#define  EType_dANDbXORac        1   //  this suits for the case of d&b^a^c
#define  EType_dANDbcXORab       2   //  this suits for the case of d&b^d&c^a^b
#define  EType_bANDcXORa         3   //  this suits for the case of c&b^a
#define  EType_NoDeal            0 

#define  CaseNumSet              1100 // The Storable maximum solution  number of each coordinate is set to be 1000, according to the test, 20000 is enough large.
#define  Var4Share3Space         4096
char FileName[30]="Gen2orderGiftG.txt";
...
/*TableType1
TransLinearItem_b3Sc123a123: b&c^a   b and c is the items  in nolinear items, a is only linear item
...
-----------------------------------------
*/
void TransLinearItem_b3Sc123a123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][7],unsigned char*   XorValue[4][9][7]) 
 {
...
//the XOR values of  linear items  in the all possible composed items.		
                ...
                for(CompIndex=0;CompIndex<9;CompIndex++)
	               {
	            	...
	            	if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
	            		  { 
	            	       ...
	            	       XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=c1  ; //c1  type[3]   for comp0  comp1   comp2
	            		  } 
	            	else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
	            		  { 
						   XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a2  ; // a2  type[1]   for comp1  comp4   comp7
	            	      XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=c2 ; //c2  type[2]   for comp3  comp4   comp5
	            	       } 
	            	else 
	            		   {
						   XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a3;//a3  type[1]   for comp2  comp5   comp8
	            	        XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=c3;//c3  type[2]   for comp6  comp7   comp8  
	            	       } 
 ...
 /*TableType2
TransLinearItem_d3Sc123b123a123OneTwo: bd^cd^b  b and d is the items  in nolinear items, a is only linear item
        type[0]    type[1]    type[2]    type[3]   type[4]  type[5]  type[6]  
comp_0     0          a1        b1         c1       a1+b1    a1+c1    c1+b1    
comp_1     0          a2        b2         c2       a2+b2    a2+c2    c2+b2    
comp_2     0          a3        b3         c3       a3+b3    a3+c3    c3+b3   
----------------------------------------------------------------------------
comp_3     0          a1        b1         c1       a1+b1    a1+c1    c1+b1     
comp_4     0          a2        b2         c2       a2+b2    a2+c2    c2+b2     
comp_5     0          a3        b3         c3       a3+b3    a3+c3    c3+b3     
----------------------------------------------------------------------------
comp_6     0          a1        b1         c1       a1+b1    a1+c1    c1+b1   
comp_7     0          a2        b2         c2       a2+b2    a2+c2    c2+b2   
comp_8     0          a3        b3         c3       a3+b3    a3+c3    c3+b3   
----------------------------------------------------------------------------
*/
void TransLinearItem_d3Sc123b123a123OneTwo(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][7],unsigned char*   XorValue[4][9][7]) 
 {
	 unsigned short	Masked_InputIndex,i,CompIndex;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	 ...
	 // the linear items  in the all possible composed items in our bebuiled Table.	
	   for(CompIndex=0;CompIndex<9;CompIndex++)
	   {
		   ...
		   if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
			  ...
			  TransLinearItem[CoordIndex][CompIndex][3]= 0x020  ; //c1     type[3]   for comp0  comp3   comp6
			  TransLinearItem[CoordIndex][CompIndex][4]= 0x900  ; //a1+b1  type[4]   for comp0  comp3   comp6
			  TransLinearItem[CoordIndex][CompIndex][5]= 0x820  ; //a1+c1  type[5]   for comp0  comp3   comp6
			  TransLinearItem[CoordIndex][CompIndex][6]= 0x120  ; //b1+c1  type[6]   for comp0  comp3   comp6
			  } 
		  else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
			  { 
			  TransLinearItem[CoordIndex][CompIndex][1]=0x400   ;  //a2    type[1]   for comp1  comp4   comp7
		      TransLinearItem[CoordIndex][CompIndex][2]=0x080    ; //b2     type[2]   for comp1  comp4   comp7
			  TransLinearItem[CoordIndex][CompIndex][3]=0x010    ; //c2     type[3]   for comp1  comp4   comp7
			  TransLinearItem[CoordIndex][CompIndex][4]=0x480   ;  //a2+b2  type[4]   for comp1  comp4   comp7
			  TransLinearItem[CoordIndex][CompIndex][5]=0x410    ; //a2+c2  type[5]   for comp1  comp4   comp7
			  TransLinearItem[CoordIndex][CompIndex][6]=0x090    ; //b2+c2  type[6]   for comp1  comp4   comp7
              } 
		  else 
			  { 
			  TransLinearItem[CoordIndex][CompIndex][1]=0x200;//a3     type[1]   for comp2  comp5   comp8
		      TransLinearItem[CoordIndex][CompIndex][2]=0x040;//b3     type[2]   for comp2  comp5   comp8
			  TransLinearItem[CoordIndex][CompIndex][3]=0x008;//c3     type[3]   for comp2  comp5   comp8
			  TransLinearItem[CoordIndex][CompIndex][4]=0x240;//a3+b3  type[4]   for comp2  comp5   comp8
		      TransLinearItem[CoordIndex][CompIndex][5]=0x208;//a3+c3  type[5]   for comp2  comp5   comp8
			  TransLinearItem[CoordIndex][CompIndex][6]=0x048;//c3+b3  type[6]   for comp2  comp5   comp8
               } 
	   } 
                ...
                for(CompIndex=0;CompIndex<9;CompIndex++)
	               {
	            	...
	            	if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
	            		  { 
						   ...
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]= c1  ; //c1  type[3]   for comp0  comp3   comp6
						   XorValue[CoordIndex][CompIndex][4][Masked_InputIndex]= a1^b1  ; //a1+b1   type[4]   for comp0  comp3   comp6
	            	       XorValue[CoordIndex][CompIndex][5][Masked_InputIndex]= a1^c1  ; //a1+c1  type[5]   for comp0  comp3   comp6
						   XorValue[CoordIndex][CompIndex][6][Masked_InputIndex]= c1^b1  ; //c1 +b1 type[6]   for comp0  comp3   comp6
	            		  ...
	            		  { 
						   ...
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]=c2       ; //c2     type[3]   for comp1  comp4   comp7
						   XorValue[CoordIndex][CompIndex][4][Masked_InputIndex]=a2^b2    ; //a2+b2  type[4]   for comp1  comp4   comp7
						   XorValue[CoordIndex][CompIndex][5][Masked_InputIndex]=a2^c2    ; //a2+c2  type[5]   for comp1  comp4   comp7
						   XorValue[CoordIndex][CompIndex][6][Masked_InputIndex]=c2^b2    ; //c2+b2  type[6]   for comp1  comp4   comp7
	            	       } 
	            	else 
	            		   {
						   XorValue[CoordIndex][CompIndex][1][Masked_InputIndex]=a3;   //a3     type[1]   for comp2  comp5   comp8
	            	       XorValue[CoordIndex][CompIndex][2][Masked_InputIndex]=b3;   //b3     type[2]   for comp2  comp5   comp8
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]=c3;   //c3     type[3]   for comp2  comp5   comp8
						   XorValue[CoordIndex][CompIndex][4][Masked_InputIndex]=a3^b3;//a3+b3  type[4]   for comp2  comp5   comp8
						   XorValue[CoordIndex][CompIndex][5][Masked_InputIndex]=a3^c3;//a3+c3  type[5]   for comp2  comp5   comp8
						   XorValue[CoordIndex][CompIndex][6][Masked_InputIndex]=b3^c3;//c3+b3  type[6]   for comp2  comp5   comp8
	            	       } 
...
void NotTrans(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][7],unsigned char*   XorValue[4][9][7]) 
 {
	 unsigned short	Masked_InputIndex,i;
	 // the linear items  in the all possible composed items in our bebuiled Table.	
...
void MakeSearchDisUnifTable(unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7],unsigned char*   XorValue[4][9][7], unsigned char TableType[4]
)// InitLinearItem1[CompIndex]:CompIndex:0-8;  TransLinearItem[CompIndex][Type]:Type:0-7, XorValue[CompIndex][Type][Masked_InputIndex]: Masked_InputIndex:0-4095.
{
    ...
    for( CoordIndex=0;CoordIndex<4;CoordIndex++)
		{
			if(TableType[CoordIndex]==B3SameIntuple_c123a123)	
			    TransLinearItem_b3Sc123a123(CoordIndex,   TransLinearItem, XorValue);
			else if(TableType[CoordIndex]==D3SameIntuple_c123b123a123OneTwo)
			    TransLinearItem_d3Sc123b123a123OneTwo(CoordIndex,   TransLinearItem, XorValue);
			else
...
c&b^a
*/
void InputTableIndexGen_NLbcLa(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7])
{	
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				//---component 0  
				#if 0
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(c1<<2)|(b1<<0); 
				InputTableIndex[CoordIndex][1][Masked_InputIndex]=        (c2<<2)|(b1<<0);
				InputTableIndex[CoordIndex][2][Masked_InputIndex]=        (c3<<2)|(b1<<0);
				InputTableIndex[CoordIndex][3][Masked_InputIndex]=        (c1<<2)|(b2<<0);
				
				//InputTableIndex[CoordIndex][4][Masked_InputIndex]=        (c2<<2)|(b2<<0);
				//InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a2<<3)|(c3<<2)|(b2<<0);
				
				InputTableIndex[CoordIndex][4][Masked_InputIndex]=  (a2<<3)|(c2<<2)|(b2<<0);
				InputTableIndex[CoordIndex][5][Masked_InputIndex]=          (c3<<2)|(b2<<0);
				
				
				InputTableIndex[CoordIndex][6][Masked_InputIndex]=        (c1<<2)|(b3<<0);
				InputTableIndex[CoordIndex][7][Masked_InputIndex]=        (c2<<2)|(b3<<0);
				InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(c3<<2)|(b3<<0);
                ...
                if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x800)
				     ...
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a2<<3)|(c1<<2)|(b1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a3<<3)|(c1<<2)|(b1<<0); 
				else 
					 InputTableIndex[CoordIndex][0][Masked_InputIndex]=(c1<<2)|(b1<<0); 
				//---component 1 d1b2
				if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a1<<3)|(c2<<2)|(b1<<0);
				else if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(c2<<2)|(b1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a3<<3)|(c2<<2)|(b1<<0); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(c2<<2)|(b1<<0); 				
				//---component 2  d1b3
				if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a1<<3)|(c3<<2)|(b1<<0);
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a2<<3)|(c3<<2)|(b1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(c3<<2)|(b1<<0);  
				else
					 InputTableIndex[CoordIndex][2][Masked_InputIndex]=(c3<<2)|(b1<<0);  
				 
                //---component 3  d2b1+a2  
				if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(c1<<2)|(b2<<0);
				else if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a2<<3)|(c1<<2)|(b2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a3<<3)|(c1<<2)|(b2<<0);  
				else
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(c1<<2)|(b2<<0);
				...
				if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a1<<3)|(c2<<2)|(b2<<0);
				else if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(c2<<2)|(b2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a3<<3)|(c2<<2)|(b2<<0);
				 else
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(c2<<2)|(b2<<0);
				//---component 5 d2b3
				if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a1<<3)|(c3<<2)|(b2<<0);
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a2<<3)|(c3<<2)|(b2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(c3<<2)|(b2<<0);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(c3<<2)|(b2<<0);

                //---component 6   d3b1+a3 
				if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(c1<<2)|(b3<<0);
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a2<<3)|(c1<<2)|(b3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a3<<3)|(c1<<2)|(b3<<0);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(c1<<2)|(b3<<0);	
				 //---component 7  d3b2
				if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a1<<3)|(c2<<2)|(b3<<0);
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(c2<<2)|(b3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a3<<3)|(c2<<2)|(b3<<0);
				else 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(c2<<2)|(b3<<0);
                //---component 8 d3b3
				if ((InitTranComLinearItem[CoordIndex][8] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a1<<3)|(c3<<2)|(b3<<0);
				else if ((InitTranComLinearItem[CoordIndex][8] &0xe00)==0x400)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a2<<3)|(c3<<2)|(b3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][8] &0xe00)==0x200)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(c3<<2)|(b3<<0);
				else 
          			InputTableIndex[CoordIndex][8][Masked_InputIndex]=(c3<<2)|(b3<<0);
          		#endif
...
/*Exprssion Type2*/
void  InputTableIndexGen_NLdbcLab(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7])
{
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
                ...
                if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c1<<1)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x400)         
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a2<<3)|(b1<<2)|(c1<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][0] &0xe00)==0x200)         
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a3<<3)|(b1<<2)|(c1<<1)|(d1<<0); 
				 else 
				...
				//---component 2  d1&b3 
				if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a1<<3)|(b3<<2)|(c3<<1)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x400)         
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a2<<3)|(b3<<2)|(c3<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0xe00)==0x200)         
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c3<<1)|(d1<<0);  
				else
				...
				if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a1<<3)|(b2<<2)|(c2<<1)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x400)         
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c2<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0xe00)==0x200)         
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a3<<3)|(b2<<2)|(c2<<1)|(d2<<0);
				 else
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d2<<0);
				//---component 5 d2&b3
				if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a1<<3)|(b3<<2)|(c3<<1)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x400)         
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a2<<3)|(b3<<2)|(c3<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0xe00)==0x200)         
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c3<<1)|(d2<<0);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(b3<<2)|(c3<<1)|(d2<<0);

                //---component 6  d3&b1
				if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c1<<1)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x400)         
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a2<<3)|(b1<<2)|(c1<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x200)         
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(a3<<3)|(b1<<2)|(c1<<1)|(d3<<0);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(b1<<2)|(c1<<1)|(d3<<0);	
				 //---component 7 d3&b2
				if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x800)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a1<<3)|(b2<<2)|(c2<<1)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x400)         
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c2<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0xe00)==0x200)         
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a3<<3)|(b2<<2)|(c2<<1)|(d3<<0);
				else 
...
void InputTableIndexGen_NLdbLac(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7])
{	
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				d3=(a3b3c3d3>>3)&0x01;
				//---component 0  f2_0=d1&b1^a1
                if ((InitTranComLinearItem[CoordIndex][0] &0x820)==0x800)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(b1<<2)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][0] &0x820)==0x020)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2)|(c1<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][0] &0x820)==0x820)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c1<<1)|(d1<<0); 
				 else 
					 InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2)|(d1<<0); 
				//---component 1 d1&b2^c2  
				if ((InitTranComLinearItem[CoordIndex][1] &0x410)==0x400)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(b2<<2)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][1] &0x410)==0x010)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0x410)==0x410)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c2<<1)|(d1<<0); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(b2<<2)|(d1<<0); 				
				//---component 2  d1&b3 
				if ((InitTranComLinearItem[CoordIndex][2] &0x208)==0x200)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(b3<<2)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][2] &0x208)==0x008)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(b3<<2)|(c3<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0x208)==0x208)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c3<<1)|(d1<<0);  
				else
                ...
                if ((InitTranComLinearItem[CoordIndex][3] &0x820)==0x800)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(b1<<2)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][3] &0x820)==0x020)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(b1<<2)|(c1<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0x820)==0x820)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(a1<<3)|(b1<<2)|(c1<<1)|(d2<<0); 
				 else 
					 InputTableIndex[CoordIndex][3][Masked_InputIndex]=(b1<<2)|(d2<<0); 				 

				 //---component 4 d2&b2^a2

					
				if ((InitTranComLinearItem[CoordIndex][4] &0x410)==0x400)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(b2<<2)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][4] &0x410)==0x010)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0x410)==0x410)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c2<<1)|(d2<<0); 
                else
				...
				if ((InitTranComLinearItem[CoordIndex][5] &0x208)==0x200)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(b3<<2)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][5] &0x208)==0x008)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(b3<<2)|(c3<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0x208)==0x208)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c3<<1)|(d2<<0);  
				else
				...
				if ((InitTranComLinearItem[CoordIndex][6] &0xe00)==0x800)
				 ...
				 //---component 7 d3&b2	
          		if ((InitTranComLinearItem[CoordIndex][7] &0x410)==0x400)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(b2<<2)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][7] &0x410)==0x010)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0x410)==0x410)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(a2<<3)|(b2<<2)|(c2<<1)|(d3<<0); 
                else
                    InputTableIndex[CoordIndex][7][Masked_InputIndex]=(b2<<2)|(d3<<0); 		
          			
                //---component 8 d3&b3^a3^c3 
          		if ((InitTranComLinearItem[CoordIndex][8] &0x208)==0x200)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(b3<<2)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][8] &0x208)==0x008)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(b3<<2)|(c3<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][8] &0x208)==0x208)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(a3<<3)|(b3<<2)|(c3<<1)|(d3<<0);  
				else
					 InputTableIndex[CoordIndex][8][Masked_InputIndex]=(b3<<2)|(d3<<0);  	
...
void MakeLargeTables( unsigned char  Type[4][9], unsigned char*     InputTableIndex[4][9], unsigned char*     F3FullMaskValue[4][3],unsigned char*     F3To1UnMaskValue[4][3],unsigned char*   XorValue[4][9][7],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][7],unsigned short  InitTranComLinearItem[4][9],unsigned char ExpressionType[4])
{
	...
	unsigned char  f0_1c,f0_2c,f0_3c,f0_4c,f0_5c,f0_6c,f0_7c,f0_8c,f0_9c;
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
		if(ExpressionType[CoordIndex]==EType_dANDbXORac) 
			InputTableIndexGen_NLdbLac(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
		else if(ExpressionType[CoordIndex]==EType_dANDbcXORab)
			InputTableIndexGen_NLdbcLab(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
		else if(ExpressionType[CoordIndex]==EType_bANDcXORa)
			InputTableIndexGen_NLbcLa(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
	 }
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				CoordIndex=1;
				InputTableIndex[CoordIndex][0][Masked_InputIndex]=(d1<<1);
				InputTableIndex[CoordIndex][1][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][2][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][3][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][4][Masked_InputIndex]=(d2<<1);
				InputTableIndex[CoordIndex][5][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][6][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][7][Masked_InputIndex]=0;
				InputTableIndex[CoordIndex][8][Masked_InputIndex]=(d3<<1);	
			    ...
			    f0_1=b1&d1 ^ c1    ^ XorValue[0][0][Type[0][0]][Masked_InputIndex];     
				f0_2=b2&d1             ^ XorValue[0][1][Type[0][1]][Masked_InputIndex] ;    
				f0_3=b3&d1             ^ XorValue[0][2][Type[0][2]][Masked_InputIndex] ;    
                f0_4=b1&d2         ^ XorValue[0][3][Type[0][3]][Masked_InputIndex];     
                f0_5=b2&d2^ c2     ^ XorValue[0][4][Type[0][4]][Masked_InputIndex];     
                f0_6=b3&d2             ^ XorValue[0][5][Type[0][5]][Masked_InputIndex];     
			    f0_7=b1&d3             ^ XorValue[0][6][Type[0][6]][Masked_InputIndex];    
				f0_8=b2&d3        ^ XorValue[0][7][Type[0][7]][Masked_InputIndex];    
				f0_9=b3&d3 ^ c3       ^ XorValue[0][8][Type[0][8]][Masked_InputIndex] ;
				...
				f2_1=b1&c1 ^ a1      ^ XorValue[2][0][Type[2][0]][Masked_InputIndex]  ;
				f2_2=b1&c2           ^ XorValue[2][1][Type[2][1]][Masked_InputIndex]  ;
				f2_3=b1&c3           ^ XorValue[2][2][Type[2][2]][Masked_InputIndex]  ;
				f2_4=b2&c1           ^ XorValue[2][3][Type[2][3]][Masked_InputIndex]  ;
				f2_5=b2&c2 ^ a2      ^ XorValue[2][4][Type[2][4]][Masked_InputIndex]  ;
				f2_6=b2&c3           ^ XorValue[2][5][Type[2][5]][Masked_InputIndex]  ;
				f2_7=b3&c1           ^ XorValue[2][6][Type[2][6]][Masked_InputIndex]  ;
				f2_8=b3&c2           ^ XorValue[2][7][Type[2][7]][Masked_InputIndex]  ;
                f2_9=b3&c3 ^ a3      ^ XorValue[2][8][Type[2][8]][Masked_InputIndex]  ;
				...
				f3_1=d1&b1^d1&c1^b1   ^ XorValue[3][0][Type[3][0]][Masked_InputIndex] ;
				f3_2=d1&b2^d1&c2          ^ XorValue[3][1][Type[3][1]][Masked_InputIndex] ;
				f3_3=d1&b3^d1&c3       ^ XorValue[3][2][Type[3][2]][Masked_InputIndex] ;
				f3_4=d2&b1^d2&c1       ^ XorValue[3][3][Type[3][3]][Masked_InputIndex] ;  //
				f3_5=d2&b2^d2&c2^b2    ^ XorValue[3][4][Type[3][4]][Masked_InputIndex] ;
				f3_6=d2&b3^d2&c3       ^ XorValue[3][5][Type[3][5]][Masked_InputIndex] ;
				f3_7=d3&b1^d3&c1           ^ XorValue[3][6][Type[3][6]][Masked_InputIndex] ; 
				f3_8=d3&b2^d3&c2       ^ XorValue[3][7][Type[3][7]][Masked_InputIndex] ; 
				f3_9=d3&b3^d3&c3^b3       ^ XorValue[3][8][Type[3][8]][Masked_InputIndex] ;
...
void OneAndTwoGenerateTypeNumber( unsigned char Coordinate ,  unsigned char CompIndex,unsigned char  Type[4][9] ,unsigned char  TypeRage[4][9][7],  unsigned char  TypeN[4][9],unsigned char  TypeRageNum[4][9])
{
	...
	if(((Type[Coordinate][RelateCompIndex1]==1)||(Type[Coordinate][RelateCompIndex1]==4)||(Type[Coordinate][RelateCompIndex1]==5))&&((Type[Coordinate][RelateCompIndex2]==1)||(Type[Coordinate][RelateCompIndex2]==4)||(Type[Coordinate][RelateCompIndex2]==5)))
	{
		if(((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==1))||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==5))||((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==4)))
		{
			TypeRage[Coordinate][CompIndex][0]=0;
			TypeRageNum[Coordinate][CompIndex]=1;	
		}
		else if(((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==4))||((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==1)))
		{
			TypeRage[Coordinate][CompIndex][0]=2;
			TypeRageNum[Coordinate][CompIndex]=1;	
		}
		
		else if(((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==5))||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==1)))
		{
			TypeRage[Coordinate][CompIndex][0]=3;
			TypeRageNum[Coordinate][CompIndex]=1;	
		}
		else if(((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==5))||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==4)))
		{
			TypeRage[Coordinate][CompIndex][0]=6;
			TypeRageNum[Coordinate][CompIndex]=1;	
		}

	}     
	else if((((Type[Coordinate][RelateCompIndex1]!=1)&&(Type[Coordinate][RelateCompIndex1]!=4)&&(Type[Coordinate][RelateCompIndex1]!=5))&&((Type[Coordinate][RelateCompIndex2]==1)||(Type[Coordinate][RelateCompIndex2]==4)||(Type[Coordinate][RelateCompIndex2]==5)))||(((Type[Coordinate][RelateCompIndex1]==1)||(Type[Coordinate][RelateCompIndex1]==4)||(Type[Coordinate][RelateCompIndex1]==5))&&((Type[Coordinate][RelateCompIndex2]!=1)&&(Type[Coordinate][RelateCompIndex2]!=4)&&(Type[Coordinate][RelateCompIndex2]!=5))))
	{
		
		if(((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==1))||((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==4))||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==5)))
		  {
			TypeRage[Coordinate][CompIndex][0]=1;
			TypeRageNum[Coordinate][CompIndex]=1;	
		  }    
		else if(((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==4))||((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==1))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==5)))
		  {
			TypeRage[Coordinate][CompIndex][0]=4;
			TypeRageNum[Coordinate][CompIndex]=1;	
		  }
		else if(((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==5))||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==1))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==4)))
		  {
			TypeRage[Coordinate][CompIndex][0]=5;
			TypeRageNum[Coordinate][CompIndex]=1;	
		  }

		else if(((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==5))||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==4))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==1)))
		  {
			TypeRageNum[Coordinate][CompIndex]=0;	
		  }
          
		  else if(((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==0))||((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==2))||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==3)))
		  {
			TypeRage[Coordinate][CompIndex][0]=1;
			TypeRageNum[Coordinate][CompIndex]=1;  
		  }
		  
		 else if((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==2)||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==6))||((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==0)))
		  {
			TypeRage[Coordinate][CompIndex][0]=4;
			TypeRageNum[Coordinate][CompIndex]=1;  
		  } 
		  else if(((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==3))||((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==6))||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==0)))
		  {
			TypeRage[Coordinate][CompIndex][0]=5;
			TypeRageNum[Coordinate][CompIndex]=1;  
		  }
		  else if(((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==6))||((Type[Coordinate][RelateCompIndex1]==4)&&(Type[Coordinate][RelateCompIndex2]==3))||((Type[Coordinate][RelateCompIndex1]==5)&&(Type[Coordinate][RelateCompIndex2]==2)))
		  {
			TypeRageNum[Coordinate][CompIndex]=0;  
		  }
	}
	
	else if (((Type[Coordinate][RelateCompIndex1]!=1)&&(Type[Coordinate][RelateCompIndex1]!=4)&&(Type[Coordinate][RelateCompIndex1]!=5))&&((Type[Coordinate][RelateCompIndex2]!=1)&&(Type[Coordinate][RelateCompIndex2]!=4)&&(Type[Coordinate][RelateCompIndex2]!=5)))
	{
		if(((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==0))||((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==2))||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==3))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==6)))
		{
			TypeRage[Coordinate][CompIndex][0]=0;
			TypeRageNum[Coordinate][CompIndex]=1;  
		}
		else if(((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==2))||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==6))||((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==0))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==3)))
		{
			TypeRage[Coordinate][CompIndex][0]=2;
			TypeRageNum[Coordinate][CompIndex]=1; 
		}
		else if((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==3)||((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==6))||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==0))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==2)))
		{
			TypeRage[Coordinate][CompIndex][0]=3;
			TypeRageNum[Coordinate][CompIndex]=1; 
		}
		else if((Type[Coordinate][RelateCompIndex1]==0)&&(Type[Coordinate][RelateCompIndex2]==6)||((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==2))||((Type[Coordinate][RelateCompIndex1]==2)&&(Type[Coordinate][RelateCompIndex2]==3))||((Type[Coordinate][RelateCompIndex1]==6)&&(Type[Coordinate][RelateCompIndex2]==0)))
		{
			TypeRage[Coordinate][CompIndex][0]=6;
			TypeRageNum[Coordinate][CompIndex]=1; 
		}
	...
	else
	{
	  ...
	  TypeRage[Coordinate][CompIndex][3]=3;
	  TypeRage[Coordinate][CompIndex][4]=4;
	  TypeRage[Coordinate][CompIndex][5]=5;
	  TypeRage[Coordinate][CompIndex][6]=6;
	  TypeRageNum[Coordinate][CompIndex]=7;	
	}
...
void	 Type0To2GenerateTypeNumber( unsigned char Coordinate ,  unsigned char CompIndex,      unsigned char  Type[4][9] ,unsigned char  TypeRage[4][9][7],  unsigned char  TypeN[4][9],unsigned char  TypeRageNum[4][9])
{
...
//----------------------Allocate space-------------------------------------------------------------------
    Uniformity12OSCounter= (unsigned char*)calloc(4096, sizeof(unsigned char));
...
for (CoordIndex = 0; CoordIndex < 4; CoordIndex++)
	...
	for (CoordIndex = 0; CoordIndex < 4; CoordIndex++)
	{
	  ...
	  {
		for(CompIndex=0;CompIndex<9;CompIndex++)
			for(TypeIndex=0;TypeIndex<7;TypeIndex++)
		      { XorValue[CoordIndex][CompIndex][TypeIndex] = (unsigned char*)calloc(4096, sizeof(unsigned char));   // allocate space and set to be zero
			}
	  }
	for (CoordIndex = 0; CoordIndex < 4; CoordIndex++)
	{
		for(CompIndex=0;CompIndex<9;CompIndex++)
		   { 
	         InputTableIndex[CoordIndex][CompIndex] = (unsigned char*)calloc(4096, sizeof(unsigned char));   // allocate space and set to be zero
			}
		// printf("InputTableIndex");  
   }
	...
	for (CoordIndex = 0; CoordIndex < 4; CoordIndex++)
	{
		for(OutShare=0;OutShare<3;OutShare++)
		    {
			 F3FullMaskValue[CoordIndex][OutShare] = (unsigned char*)calloc(4096, sizeof(unsigned char));
		     F3To1UnMaskValue[CoordIndex][OutShare] = (unsigned char*)calloc(4096, sizeof(unsigned char));
...
TableType[2]=B3SameIntuple_c123a123;
TableTypeIndex[2]=B3SameIntuple_c123a123_Index;
TableType[3]     =D3SameIntuple_c123b123a123OneTwo;
TableTypeIndex[3]=D3SameIntuple_c123b123a123OneTwo_Index;
TableType[0]     =D3SameIntuple_c123b123a123OneTwo;
TableTypeIndex[0]=D3SameIntuple_c123b123a123OneTwo_Index;
TableType[1]=NoNeedTable;
TableTypeIndex[1]= NoNeedTable_Index;
...
ExpressionType[2]= EType_bANDcXORa  ;
ExpressionType[3]= EType_dANDbcXORab; 
ExpressionType[0]= EType_dANDbXORac;
ExpressionType[1]= EType_NoDeal;   
							...
							for(Type[CoordIndex][5]=0;Type[CoordIndex][5]<TableTypeIndex[CoordIndex]; Type[CoordIndex][5]++)
			                  {
								...
								if(TableType[CoordIndex]==B3SameIntuple_c123a123)
								      ...
								      OneAndTwoGenerateTypeNumber(CoordIndex,6, Type ,TypeRage,   TypeN,TypeRageNum);  
						 	    ...
						 	    for(TypeN[CoordIndex][6]=0;TypeN[CoordIndex][6]<TypeRageNum[CoordIndex][6]; TypeN[CoordIndex][6]++)
			                    {
									...
									if(TableType[CoordIndex]==B3SameIntuple_c123a123)
									    Type0To2GenerateTypeNumber(CoordIndex,7, Type ,TypeRage,   TypeN,TypeRageNum);
										   ...
										   OneAndTwoGenerateTypeNumber(CoordIndex,7, Type ,TypeRage,   TypeN,TypeRageNum); 
									...
									for(TypeN[CoordIndex][7]=0;TypeN[CoordIndex][7]<TypeRageNum[CoordIndex][7]; TypeN[CoordIndex][7]++)
									{
										...
										if(TableType[CoordIndex]==B3SameIntuple_c123a123)
										   ...
										   OneAndTwoGenerateTypeNumber(CoordIndex, 8,Type ,TypeRage,   TypeN,TypeRageNum);
										 ...
										 if ((res1&res2& res3)==1)
                                          {
										   ...
										   for (CompIndex=0;CompIndex<9;CompIndex++)
										     ...
										     for(OutShare=0;OutShare<3;OutShare++)
										      ...
										      if(CaseNum[CoordIndex]>=CaseNumSet)
										      {
										      Type[CoordIndex][0]=TableTypeIndex[CoordIndex];	
										      Type[CoordIndex][1]=TableTypeIndex[CoordIndex];	
										      Type[CoordIndex][2]=TableTypeIndex[CoordIndex];	
										      Type[CoordIndex][3]=TableTypeIndex[CoordIndex];	
										      Type[CoordIndex][4]=TableTypeIndex[CoordIndex];	
										      Type[CoordIndex][5]=TableTypeIndex[CoordIndex];	
										      TypeN[CoordIndex][6]=TypeRageNum[CoordIndex][6];		
										      TypeN[CoordIndex][7]=TypeRageNum[CoordIndex][7];		
										      TypeN[CoordIndex][8]=TypeRageNum[CoordIndex][8];	
											  }
                                          } 
				...
				for(int k=0;k<CaseNum[CoordIndex3];k++)
					{
						...
						fprintf(F, "========================================\n"); 
						   for (i=0;i<9;i++)
						   {
							fprintf(F, "%s  %s ; \n",f0BaseExpression[i],  f0AddItems[i][Type[CoordIndex0][i]]);
						   }
						  fprintf(F, "========================================\n");
						   for (i=0;i<9;i++)
						   {
							fprintf(F, "%s  ; \n",f1BaseExpression[i]);
							 ...
							 for (i=0;i<9;i++)
						   {
							fprintf(F, "%s   %s;  \n",f2BaseExpression[i],  f2AddItems[i][Type[CoordIndex1][i]]);
						   }	
						  fprintf(F, "========================================\n");
						   for (i=0;i<9;i++)
						   {
							fprintf(F, "%s  %s; \n",f3BaseExpression[i],  f3AddItems[i][Type[CoordIndex2][i]]);
						   }	
						   fprintf(F, "========================================\n");	
							...
							if(flag==0)
						   {
                            ...
                            uint64_t totoltime_us=  (end.tv_sec - start.tv_sec)*1000000 +  (end.tv_usec - start.tv_usec);
                            							
                            fprintf(F,"The time for finding the first scheme  :%lld  us \n  ", totoltime_us); 							
						   }
