...
f0_0=d1&b1^d1     || f1_0=d1&b1            || f2_0=d1&b1^d1&c1          || f3_0=d1&b1^d1&c1^a1     
f0_1=d1&b2^c2     || f1_1=d1&b2^c2         || f2_1=d1&b2^d1&c2^b2       || f3_1=d1&b2^d1&c2^b2     
f0_2=d1&b3        || f1_2=d1&b3            || f2_2=d1&b3^d1&c3          || f3_2=d1&b3^d1&c3        
f0_3=d2&b1^c1     || f1_3=d2&b1^c1         || f2_3=d2&b1^d2&c1^b1       || f3_3=d2&b1^d2&c1^b1     
f0_4=d2&b2^d2     || f1_4=d2&b2            || f2_4=d2&b2^d2&c2          || f3_4=d2&b2^d2&c2^a2     
f0_5=d2&b3        || f1_5=d2&b3            || f2_5=d2&b3^d2&c3          || f3_5=d2&b3^d2&c3        
f2_6=d3&b1        || f1_6=d3&b1            || f2_6=d3&b1^d3&c1          || f3_6=d3&b1^d3&c1        
f0_7=d3&b2        || f1_7=d3&b2            || f2_7=d3&b2^d3&c2          || f3_7=d3&b2^d3&c2        
f0_8=d3&b3^d3^c3  || f1_8=d3&b3^c3         || f2_8=d3&b3^d3&c3^b3       || f3_8=d3&b3^d3&c3^a3^b3  */
...
#define D3SameIntuple_c123b123a123  2
#define NoNeedTable    0
// TableIndex
#define D3SameIntuple_c123b123_Index 3
#define  D3SameIntuple_c123b123a123_Index 4
#define  NoNeedTable_Index 0

//ExpressionType

#define  EType_dANDbXORc         1  //  this suits for the case of  d&b^c
#define  EType_dANDbcXORb        2  //  this suits for the case of  d&b^d&c^b
#define  EType_dANDbcXORab       3   //  this suits for the case of d&b^d&c^a^b
...
//the XOR values of  linear items  in the all possible composed items.		
 ...
 /* Table Type2
TransLinearItem_d3Sc123b123a123: b&d^a   b and d is the items  in nolinear items, a is only linear item
...
*/
void TransLinearItem_d3Sc123b123a123(unsigned char CoordIndex,   unsigned short  TransLinearItem[4][9][4],unsigned char*   XorValue[4][9][4]) 
 {
                ...
                for(CompIndex=0;CompIndex<9;CompIndex++)
	               {
	            	...
	            	if((CompIndex==0)||(CompIndex==3)||(CompIndex==6))
	            		  { 
						   ...
						   XorValue[CoordIndex][CompIndex][3][Masked_InputIndex]= c1  ; //b1  type[3]   for comp0  comp3   comp6
	            		  } 
	            	else if((CompIndex==1)||(CompIndex==4)||(CompIndex==7))
	            		  { 
...
)// InitLinearItem1[CompIndex]:CompIndex:0-8;  TransLinearItem[CompIndex][Type]:Type:0-7, XorValue[CompIndex][Type][Masked_InputIndex]: Masked_InputIndex:0-4095.
{
   ...
   for( CoordIndex=0;CoordIndex<4;CoordIndex++)
		{
			if(TableType[CoordIndex]==D3SameIntuple_c123b123)  // Table Type1
			   TransLinearItem_d3Sb123c123(CoordIndex,   TransLinearItem, XorValue);
			else if(TableType[CoordIndex]==D3SameIntuple_c123b123a123) // Table Type2
			    TransLinearItem_d3Sc123b123a123(CoordIndex,   TransLinearItem, XorValue);
			else
...
/* Expression Type1: it suits for the case of d&b^c*/
void InputTableIndexGen_NLdbLc(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{	
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
                ...
                c3=(a3b3c3d3>>2)&0x01;
				d3=(a3b3c3d3>>3)&0x01;
				//---component 0  //d1b1+a1+1
                if ((InitTranComLinearItem[CoordIndex][0] &0x038)==0x020)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2)|(c1<<1)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][0] &0x038)==0x010)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2)|(c2<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][0] &0x038)==0x008)
				     InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2)|(c3<<1)|(d1<<0); 
				 else 
					 InputTableIndex[CoordIndex][0][Masked_InputIndex]=(b1<<2)|(d1<<0); 
				//---component 1 d1b2
				if ((InitTranComLinearItem[CoordIndex][1] &0x038)==0x020)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(b2<<2)|(c1<<1)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][1] &0x038)==0x010)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][1] &0x038)==0x008)
				     InputTableIndex[CoordIndex][1][Masked_InputIndex]=(b2<<2)|(c3<<1)|(d1<<0); 
                else
                    InputTableIndex[CoordIndex][1][Masked_InputIndex]=(b2<<2)|(d1<<0); 				
				//---component 2  d1b3
				if ((InitTranComLinearItem[CoordIndex][2] &0x038)==0x020)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(b3<<2)|(c1<<1)|(d1<<0);
				else if ((InitTranComLinearItem[CoordIndex][2] &0x038)==0x010)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(b3<<2)|(c2<<1)|(d1<<0); 
				else if ((InitTranComLinearItem[CoordIndex][2] &0x038)==0x008)
				     InputTableIndex[CoordIndex][2][Masked_InputIndex]=(b3<<2)|(c3<<1)|(d1<<0);  
				else
					 InputTableIndex[CoordIndex][2][Masked_InputIndex]=(b3<<2)|(d1<<0);  
				 
                //---component 3  d2b1+a2  
				if ((InitTranComLinearItem[CoordIndex][3] &0x038)==0x020)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(b1<<2)|(c1<<1)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][3] &0x038)==0x010)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(b1<<2)|(c2<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][3] &0x038)==0x008)
				     InputTableIndex[CoordIndex][3][Masked_InputIndex]=(b1<<2)|(c3<<1)|(d2<<0);  
				else
					InputTableIndex[CoordIndex][3][Masked_InputIndex]=(b1<<2)|(d2<<0);
				 
				 //---component 4 d2b2

				if ((InitTranComLinearItem[CoordIndex][4] &0x038)==0x020)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2)|(c1<<1)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][4] &0x038)==0x010)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][4] &0x038)==0x008)
				     InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2)|(c3<<1)|(d2<<0);
				 else
					InputTableIndex[CoordIndex][4][Masked_InputIndex]=(b2<<2)|(d2<<0);
				//---component 5 d2b3
				if ((InitTranComLinearItem[CoordIndex][5] &0x038)==0x020)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(b3<<2)|(c1<<1)|(d2<<0);
				else if ((InitTranComLinearItem[CoordIndex][5] &0x038)==0x010)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(b3<<2)|(c2<<1)|(d2<<0); 
				else if ((InitTranComLinearItem[CoordIndex][5] &0x038)==0x008)
				     InputTableIndex[CoordIndex][5][Masked_InputIndex]=(b3<<2)|(c3<<1)|(d2<<0);
				else 
					InputTableIndex[CoordIndex][5][Masked_InputIndex]=(b3<<2)|(d2<<0);

                //---component 6   d3b1+a3 
				if ((InitTranComLinearItem[CoordIndex][6] &0x038)==0x020)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(b1<<2)|(c1<<1)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][6] &0x038)==0x010)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(b1<<2)|(c2<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][6] &0x038)==0x008)
				     InputTableIndex[CoordIndex][6][Masked_InputIndex]=(b1<<2)|(c3<<1)|(d3<<0);
				else 
          			InputTableIndex[CoordIndex][6][Masked_InputIndex]=(b1<<2)|(d3<<0);	
				 //---component 7  d3b2
				if ((InitTranComLinearItem[CoordIndex][7] &0x038)==0x020)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(b2<<2)|(c1<<1)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][7] &0x038)==0x010)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(b2<<2)|(c2<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][7] &0x038)==0x008)
				     InputTableIndex[CoordIndex][7][Masked_InputIndex]=(b2<<2)|(c3<<1)|(d3<<0);
				else 
          			InputTableIndex[CoordIndex][7][Masked_InputIndex]=(b2<<2)|(d3<<0);
                //---component 8 d3b3
				if ((InitTranComLinearItem[CoordIndex][8] &0x038)==0x020)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(b3<<2)|(c1<<1)|(d3<<0);
				else if ((InitTranComLinearItem[CoordIndex][8] &0x038)==0x010)
				     InputTableIndex[CoordIndex][8][Masked_InputIndex]=(b3<<2)|(c2<<1)|(d3<<0); 
				else if ((InitTranComLinearItem[CoordIndex][8] &0x038)==0x008)
...
/*Expression Type2:  it suits for the case of d&b^d&c*/
void  InputTableIndexGen_NLdbcLb(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
...
/*Expression Type3:  it suits for the case of d&b^d&c^a^b*/
void  InputTableIndexGen_NLdbcLab(unsigned char  Type[4][9],  unsigned char CoordIndex, unsigned short  InitTranComLinearItem[4][9], unsigned char*   InputTableIndex[4][9],unsigned short  InitLinearItem[4][9],unsigned short  TransLinearItem[4][9][4])
{
	unsigned int  CompIndex, InputMask,OutShare,i;
	unsigned char  abcd,a1b1c1d1,a2b2c2d2,a3b3c3d3;
	unsigned short	Masked_InputIndex,TypeIndex;
 ...
 for(CoordIndex=0;CoordIndex<4;CoordIndex++)
	 {
		...
		if(ExpressionType[CoordIndex]==EType_dANDbXORc) // Expression Type1
			InputTableIndexGen_NLdbLc(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
		else if(ExpressionType[CoordIndex]==EType_dANDbcXORb) // Expression Type2
			InputTableIndexGen_NLdbcLb(Type,CoordIndex,InitTranComLinearItem, InputTableIndex,InitLinearItem,TransLinearItem);
		else if(ExpressionType[CoordIndex]==EType_dANDbcXORab)// Expression Type3
	   ...
	   for(a1b1c1d1=0;a1b1c1d1<16;a1b1c1d1++)
	    {
	    	...
	    	for(a2b2c2d2=0;a2b2c2d2<16;a2b2c2d2++)
	    	{
				...
				f0_1= d1&b1^d1  ^ XorValue[0][0][Type[0][0]][Masked_InputIndex]   ;
				f0_2= d1&b2^c2  ^ XorValue[0][1][Type[0][1]][Masked_InputIndex]   ;
				f0_3= d1&b3     ^ XorValue[0][2][Type[0][2]][Masked_InputIndex]   ;
				
				F3FullMaskValue[0][0][Masked_InputIndex]=(f0_3<<2)|(f0_2<<1)|(f0_1<<0);
				F3To1UnMaskValue[0][0][Masked_InputIndex]=f0_1^f0_2^f0_3;

				
				f0_4=d2&b1^c1  ^ XorValue[0][3][Type[0][3]][Masked_InputIndex]            ;
				f0_5=d2&b2^d2  ^ XorValue[0][4][Type[0][4]][Masked_InputIndex]            ;
				f0_6=d2&b3     ^ XorValue[0][5][Type[0][5]][Masked_InputIndex]            ;
				
				
				F3FullMaskValue[0][1][Masked_InputIndex]=(f0_6<<2)|(f0_5<<1)|(f0_4<<0);
				F3To1UnMaskValue[0][1][Masked_InputIndex]=f0_6^f0_5^f0_4;

				 f0_7=d3&b1        ^ XorValue[0][6][Type[0][6]][Masked_InputIndex]   ;
                 f0_8=d3&b2        ^ XorValue[0][7][Type[0][7]][Masked_InputIndex]   ;
                 f0_9=d3&b3^d3^c3  ^ XorValue[0][8][Type[0][8]][Masked_InputIndex]    ;
				...
				f1_1=d1&b1    ^ XorValue[1][0][Type[1][0]][Masked_InputIndex]   ;
                f1_2=d1&b2^c2 ^ XorValue[1][1][Type[1][1]][Masked_InputIndex]   ;
                f1_3=d1&b3    ^ XorValue[1][2][Type[1][2]][Masked_InputIndex]   ;
				...
				f1_4=d2&b1^c1  ^ XorValue[1][3][Type[1][3]][Masked_InputIndex] ;
                f1_5=d2&b2     ^ XorValue[1][4][Type[1][4]][Masked_InputIndex] ;
                f1_6=d2&b3     ^ XorValue[1][5][Type[1][5]][Masked_InputIndex] ;
				...
				f1_7=d3&b1    ^ XorValue[1][6][Type[1][6]][Masked_InputIndex]   ; 
                f1_8=d3&b2    ^ XorValue[1][7][Type[1][7]][Masked_InputIndex]   ; 
                f1_9=d3&b3^c3 ^ XorValue[1][8][Type[1][8]][Masked_InputIndex]    ; 
				...
				f2_1=d1&b1^d1&c1       ^ XorValue[2][0][Type[2][0]][Masked_InputIndex];  
                f2_2=d1&b2^d1&c2^b2      ^ XorValue[2][1][Type[2][1]][Masked_InputIndex] ; 
				f2_3=d1&b3^d1&c3         ^ XorValue[2][2][Type[2][2]][Masked_InputIndex] ; 

				F3FullMaskValue[2][0][Masked_InputIndex]=(f2_3<<2)|(f2_2<<1)|(f2_1<<0);
				F3To1UnMaskValue[2][0][Masked_InputIndex]=f2_1^f2_2^f2_3;

				f2_4=d2&b1^d2&c1^b1 ^ XorValue[2][3][Type[2][3]][Masked_InputIndex];
                f2_5=d2&b2^d2&c2    ^ XorValue[2][4][Type[2][4]][Masked_InputIndex];
				f2_6=d2&b3^d2&c3    ^ XorValue[2][5][Type[2][5]][Masked_InputIndex];
				 
				F3FullMaskValue[2][1][Masked_InputIndex]=(f2_6<<2)|(f2_5<<1)|(f2_4<<0);
				F3To1UnMaskValue[2][1][Masked_InputIndex]=f2_6^f2_5^f2_4;

				f2_7=d3&b1^d3&c1   ^ XorValue[2][6][Type[2][6]][Masked_InputIndex] ;
                f2_8=d3&b2^d3&c2   ^ XorValue[2][7][Type[2][7]][Masked_InputIndex] ;
				f2_9=d3&b3^d3&c3^b3^ XorValue[2][8][Type[2][8]][Masked_InputIndex]  ;
				...
				f3_1=d1&b1^d1&c1^a1       ^ XorValue[3][0][Type[3][0]][Masked_InputIndex]   ;
				f3_2=d1&b2^d1&c2^b2       ^ XorValue[3][1][Type[3][1]][Masked_InputIndex]   ;
                ...
                f3_4= d2&b1^d2&c1^b1      ^ XorValue[3][3][Type[3][3]][Masked_InputIndex] ;
                f3_5= d2&b2^d2&c2^a2       ^ XorValue[3][4][Type[3][4]][Masked_InputIndex] ;
                ...
                f3_9=d3&b3^d3&c3^a3^b3      ^ XorValue[3][8][Type[3][8]][Masked_InputIndex]  ;		
...
void	 Type0To3GenerateTypeNumber( unsigned char Coordinate ,unsigned char CompIndex, unsigned char  Type[4][9] ,unsigned char  TypeRage[4][9][5],  unsigned char  TypeN[4][9],unsigned char  TypeRageNum[4][9])
{
	...
	else if(CompIndex==8)
	{
	  ...
	  RelateCompIndex2=5;
       ...
       if((Type[Coordinate][RelateCompIndex1]==1)&&(Type[Coordinate][RelateCompIndex2]==1))
		...
		{
			if((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]==3))
		       {
		     	TypeRage[Coordinate][CompIndex][0]=0;
		     	TypeRageNum[Coordinate][CompIndex]=1;
		        }
		    else if(((Type[Coordinate][RelateCompIndex1]==3)&&(Type[Coordinate][RelateCompIndex2]!=3)) ||((Type[Coordinate][RelateCompIndex1]!=3)&&(Type[Coordinate][RelateCompIndex2]==3)))
		       {
		...
		else 
		{
			...
			TypeRageNum[Coordinate][CompIndex]=4;
...
void	 Type0To2GenerateTypeNumber( unsigned char Coordinate ,  unsigned char CompIndex,      unsigned char  Type[4][9] ,unsigned char  TypeRage[4][9][5],  unsigned char  TypeN[4][9],unsigned char  TypeRageNum[4][9])
{
...
int main()
{
	...
	unsigned char***   F3FullMaskValueComp[4]= {NULL}; //F3FullMaskValueComp[CoordinateIndex][CaseNum][OutShare][InputMask]:CaseNum:is set to be 20000,
...
//----------------------Allocate space-------------------------------------------------------------------
   ...
   for (CoordIndex = 0; CoordIndex < 4; CoordIndex++)
	{
		DisUnifTypeCand[CoordIndex]=(unsigned char**)calloc(CaseNumSet, sizeof(unsigned char*)); // now  we  set CaseNumSet to be 20000 which can be changed to be larger
...
TableType[0]=D3SameIntuple_c123b123;
TableTypeIndex[0]= D3SameIntuple_c123b123_Index;
TableType[1]=D3SameIntuple_c123b123;
TableTypeIndex[1]= D3SameIntuple_c123b123_Index;
TableType[2]=D3SameIntuple_c123b123;
TableTypeIndex[2]= D3SameIntuple_c123b123_Index;
TableType[3]=D3SameIntuple_c123b123a123;
TableTypeIndex[3]= D3SameIntuple_c123b123a123_Index;
...
ExpressionType[0]= EType_dANDbXORc  ;
ExpressionType[1]= EType_dANDbXORc  ;
ExpressionType[2]= EType_dANDbcXORb; 
  ...
  for(Type[CoordIndex][0]=0;Type[CoordIndex][0]<TableTypeIndex[CoordIndex]; Type[CoordIndex][0]++)
   	{ 
	    for(Type[CoordIndex][1]=0;Type[CoordIndex][1]<TableTypeIndex[CoordIndex]; Type[CoordIndex][1]++)
	       {  
			for(TypeN[CoordIndex][2]=0;TypeN[CoordIndex][2]<TableTypeIndex[CoordIndex]; TypeN[CoordIndex][2]++)
			   {
							...
							for(Type[CoordIndex][5]=0;Type[CoordIndex][5]<TableTypeIndex[CoordIndex]; Type[CoordIndex][5]++)
			                  {
								...
								else if(TableType[CoordIndex]==D3SameIntuple_c123b123a123)
